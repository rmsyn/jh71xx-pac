...
pub type R = crate::R<CLK_SEC_HCLK_SPEC>;
#[doc = "Register `clk_sec_hclk` writer"]
pub type W = crate::W<CLK_SEC_HCLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_SEC_HCLK_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_SEC_HCLK_SPEC {}
