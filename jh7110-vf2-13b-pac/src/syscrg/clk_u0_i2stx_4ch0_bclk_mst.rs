#[doc = "Register `clk_u0_i2stx_4ch0_bclk_mst` reader"]
pub type R = crate::R<CLK_U0_I2STX_4CH0_BCLK_MST_SPEC>;
#[doc = "Register `clk_u0_i2stx_4ch0_bclk_mst` writer"]
pub type W = crate::W<CLK_U0_I2STX_4CH0_BCLK_MST_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_U0_I2STX_4CH0_BCLK_MST_SPEC, 0> {
        CLK_DIVCFG_W::new(self)
    }
    #[doc = "Bit 31 - 1: Clock enable, 0: Clock disable"]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U0_I2STX_4CH0_BCLK_MST_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u0_i2stx_4ch0_bclk_mst::R`](R) reader structure"]
impl crate::Readable for CLK_U0_I2STX_4CH0_BCLK_MST_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_i2stx_4ch0_bclk_mst::W`](W) writer structure"]
