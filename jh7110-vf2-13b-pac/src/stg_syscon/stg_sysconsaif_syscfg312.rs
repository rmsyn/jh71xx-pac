...
pub type U0_PLDA_PCIE_MPERSTN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLDA_PCIE_PCIE_EBUF_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLDA_PCIE_PCIE_PHY_TEST_CFG_W<'a, REG, const O: u8> =
...
pub type U0_PLDA_PCIE_PCIE_RX_EQ_TRAINING_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLDA_PCIE_PCIE_RXTERM_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLDA_PCIE_PCIE_TX_ONEZEROS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn u0_plda_pcie_mperstn(
        &mut self,
    ) -> U0_PLDA_PCIE_MPERSTN_W<STG_SYSCONSAIF_SYSCFG312_SPEC, 0> {
        U0_PLDA_PCIE_MPERSTN_W::new(self)
    }
    #[doc = "Bit 1 - u0_plda_pcie_pcie_ebuf_mode"]
    #[inline(always)]
    #[must_use]
    pub fn u0_plda_pcie_pcie_ebuf_mode(
        &mut self,
    ) -> U0_PLDA_PCIE_PCIE_EBUF_MODE_W<STG_SYSCONSAIF_SYSCFG312_SPEC, 1> {
        U0_PLDA_PCIE_PCIE_EBUF_MODE_W::new(self)
    }
    #[doc = "Bits 2:24 - u0_plda_pcie_pcie_phy_test_cfg"]
    #[inline(always)]
    #[must_use]
    pub fn u0_plda_pcie_pcie_phy_test_cfg(
        &mut self,
    ) -> U0_PLDA_PCIE_PCIE_PHY_TEST_CFG_W<STG_SYSCONSAIF_SYSCFG312_SPEC, 2> {
        U0_PLDA_PCIE_PCIE_PHY_TEST_CFG_W::new(self)
    }
    #[doc = "Bit 25 - u0_plda_pcie_pcie_rx_eq_training"]
    #[inline(always)]
    #[must_use]
    pub fn u0_plda_pcie_pcie_rx_eq_training(
        &mut self,
    ) -> U0_PLDA_PCIE_PCIE_RX_EQ_TRAINING_W<STG_SYSCONSAIF_SYSCFG312_SPEC, 25> {
        U0_PLDA_PCIE_PCIE_RX_EQ_TRAINING_W::new(self)
    }
    #[doc = "Bit 26 - u0_plda_pcie_pcie_rxterm_en"]
    #[inline(always)]
    #[must_use]
    pub fn u0_plda_pcie_pcie_rxterm_en(
        &mut self,
    ) -> U0_PLDA_PCIE_PCIE_RXTERM_EN_W<STG_SYSCONSAIF_SYSCFG312_SPEC, 26> {
        U0_PLDA_PCIE_PCIE_RXTERM_EN_W::new(self)
    }
    #[doc = "Bit 27 - u0_plda_pcie_pcie_tx_onezeros"]
    #[inline(always)]
    #[must_use]
    pub fn u0_plda_pcie_pcie_tx_onezeros(
        &mut self,
    ) -> U0_PLDA_PCIE_PCIE_TX_ONEZEROS_W<STG_SYSCONSAIF_SYSCFG312_SPEC, 27> {
        U0_PLDA_PCIE_PCIE_TX_ONEZEROS_W::new(self)
    }
