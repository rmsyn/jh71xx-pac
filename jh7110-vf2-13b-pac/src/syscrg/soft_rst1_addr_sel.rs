...
impl W {
    ...
    pub fn rstn_u0_sft7100_noc_bus_reset_venc_axi_n(
        &mut self,
    ) -> RSTN_U0_SFT7100_NOC_BUS_RESET_VENC_AXI_N_W<SOFT_RST1_ADDR_SEL_SPEC, 0> {
    ...
    pub fn rstn_u0_axi_cfg1_dec_rstn_ahb(
        &mut self,
    ) -> RSTN_U0_AXI_CFG1_DEC_RSTN_AHB_W<SOFT_RST1_ADDR_SEL_SPEC, 1> {
    ...
    pub fn rstn_u0_axi_cfg1_dec_rstn_main(
        &mut self,
    ) -> RSTN_U0_AXI_CFG1_DEC_RSTN_MAIN_W<SOFT_RST1_ADDR_SEL_SPEC, 2> {
    ...
    pub fn rstn_u0_axi_cfg0_dec_rstn_main(
        &mut self,
    ) -> RSTN_U0_AXI_CFG0_DEC_RSTN_MAIN_W<SOFT_RST1_ADDR_SEL_SPEC, 3> {
    ...
    pub fn rstn_u0_axi_cfg0_dec_rstn_main_div(
        &mut self,
    ) -> RSTN_U0_AXI_CFG0_DEC_RSTN_MAIN_DIV_W<SOFT_RST1_ADDR_SEL_SPEC, 4> {
    ...
    pub fn rstn_u0_axi_cfg0_dec_rstn_hifi4(
        &mut self,
    ) -> RSTN_U0_AXI_CFG0_DEC_RSTN_HIFI4_W<SOFT_RST1_ADDR_SEL_SPEC, 5> {
    ...
    pub fn rstn_u0_ddr_sft7110_rstn_axi(
        &mut self,
    ) -> RSTN_U0_DDR_SFT7110_RSTN_AXI_W<SOFT_RST1_ADDR_SEL_SPEC, 6> {
    ...
    pub fn rstn_u0_ddr_sft7110_rstn_osc(
        &mut self,
    ) -> RSTN_U0_DDR_SFT7110_RSTN_OSC_W<SOFT_RST1_ADDR_SEL_SPEC, 7> {
    ...
    pub fn rstn_u0_ddr_sft7110_rstn_apb(
        &mut self,
    ) -> RSTN_U0_DDR_SFT7110_RSTN_APB_W<SOFT_RST1_ADDR_SEL_SPEC, 8> {
    ...
    pub fn rstn_u0_dom_isp_top_rstn_dom_isp_top_ip_top_reset_n(
        &mut self,
    ) -> RSTN_U0_DOM_ISP_TOP_RSTN_DOM_ISP_TOP_IP_TOP_RESET_N_W<SOFT_RST1_ADDR_SEL_SPEC, 9> {
    ...
    pub fn rstn_u0_dom_isp_top_rstn_dom_isp_top_rstn_isp_axi(
        &mut self,
    ) -> RSTN_U0_DOM_ISP_TOP_RSTN_DOM_ISP_TOP_RSTN_ISP_AXI_W<SOFT_RST1_ADDR_SEL_SPEC, 10> {
    ...
    pub fn rstn_u0_dom_vout_top_rstn_dom_vout_top_rstn_vout_src(
        &mut self,
    ) -> RSTN_U0_DOM_VOUT_TOP_RSTN_DOM_VOUT_TOP_RSTN_VOUT_SRC_W<SOFT_RST1_ADDR_SEL_SPEC, 11> {
    ...
    pub fn rstn_u0_codaj12_rstn_axi(
        &mut self,
    ) -> RSTN_U0_CODAJ12_RSTN_AXI_W<SOFT_RST1_ADDR_SEL_SPEC, 12> {
    ...
    pub fn rstn_u0_codaj12_rstn_core(
        &mut self,
    ) -> RSTN_U0_CODAJ12_RSTN_CORE_W<SOFT_RST1_ADDR_SEL_SPEC, 13> {
    ...
    pub fn rstn_u0_codaj12_rstn_apb(
        &mut self,
    ) -> RSTN_U0_CODAJ12_RSTN_APB_W<SOFT_RST1_ADDR_SEL_SPEC, 14> {
    ...
    pub fn rstn_u0_wave511_rstn_axi(
        &mut self,
    ) -> RSTN_U0_WAVE511_RSTN_AXI_W<SOFT_RST1_ADDR_SEL_SPEC, 15> {
    ...
    pub fn rstn_u0_wave511_rstn_bpu(
        &mut self,
    ) -> RSTN_U0_WAVE511_RSTN_BPU_W<SOFT_RST1_ADDR_SEL_SPEC, 16> {
    ...
    pub fn rstn_u0_wave511_rstn_vce(
        &mut self,
    ) -> RSTN_U0_WAVE511_RSTN_VCE_W<SOFT_RST1_ADDR_SEL_SPEC, 17> {
    ...
    pub fn rstn_u0_wave511_rstn_apb(
        &mut self,
    ) -> RSTN_U0_WAVE511_RSTN_APB_W<SOFT_RST1_ADDR_SEL_SPEC, 18> {
    ...
    pub fn rstn_u0_vdec_jpg_arb_jpgresetn(
        &mut self,
    ) -> RSTN_U0_VDEC_JPG_ARB_JPGRESETN_W<SOFT_RST1_ADDR_SEL_SPEC, 19> {
    ...
    pub fn rstn_u0_vdec_jpg_arb_mainresetn(
        &mut self,
    ) -> RSTN_U0_VDEC_JPG_ARB_MAINRESETN_W<SOFT_RST1_ADDR_SEL_SPEC, 20> {
    ...
    pub fn rstn_u0_aximem_128b_rstn_axi(
        &mut self,
    ) -> RSTN_U0_AXIMEM_128B_RSTN_AXI_W<SOFT_RST1_ADDR_SEL_SPEC, 21> {
    ...
    pub fn rstn_u0_wave420l_rstn_axi(
        &mut self,
    ) -> RSTN_U0_WAVE420L_RSTN_AXI_W<SOFT_RST1_ADDR_SEL_SPEC, 22> {
    ...
    pub fn rstn_u0_wave420l_rstn_bpu(
        &mut self,
    ) -> RSTN_U0_WAVE420L_RSTN_BPU_W<SOFT_RST1_ADDR_SEL_SPEC, 23> {
    ...
    pub fn rstn_u0_wave420l_rstn_vce(
        &mut self,
    ) -> RSTN_U0_WAVE420L_RSTN_VCE_W<SOFT_RST1_ADDR_SEL_SPEC, 24> {
    ...
    pub fn rstn_u0_wave420l_rstn_apb(
        &mut self,
    ) -> RSTN_U0_WAVE420L_RSTN_APB_W<SOFT_RST1_ADDR_SEL_SPEC, 25> {
    ...
    pub fn rstn_u1_aximem_128b_rstn_axi(
        &mut self,
    ) -> RSTN_U1_AXIMEM_128B_RSTN_AXI_W<SOFT_RST1_ADDR_SEL_SPEC, 26> {
    ...
    pub fn rstn_u2_aximem_128b_rstn_axi(
        &mut self,
    ) -> RSTN_U2_AXIMEM_128B_RSTN_AXI_W<SOFT_RST1_ADDR_SEL_SPEC, 27> {
    ...
    pub fn rstn_u0_intmem_rom_sram_rstn_rom(
        &mut self,
    ) -> RSTN_U0_INTMEM_ROM_SRAM_RSTN_ROM_W<SOFT_RST1_ADDR_SEL_SPEC, 28> {
    ...
    pub fn rstn_u0_cdns_qspi_rstn_ahb(
        &mut self,
    ) -> RSTN_U0_CDNS_QSPI_RSTN_AHB_W<SOFT_RST1_ADDR_SEL_SPEC, 29> {
    ...
    pub fn rstn_u0_cdns_qspi_rstn_apb(
        &mut self,
    ) -> RSTN_U0_CDNS_QSPI_RSTN_APB_W<SOFT_RST1_ADDR_SEL_SPEC, 30> {
    ...
    pub fn rstn_u0_cdns_qspi_rstn_ref(
        &mut self,
    ) -> RSTN_U0_CDNS_QSPI_RSTN_REF_W<SOFT_RST1_ADDR_SEL_SPEC, 31> {
