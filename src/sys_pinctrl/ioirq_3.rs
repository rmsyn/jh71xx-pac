...
#[doc = "Field `ic_0` reader - 1: Do not clear the register, 0: Clear the register"]
pub type IC_0_R = crate::FieldReader<u32>;
#[doc = "Field `ic_0` writer - 1: Do not clear the register, 0: Clear the register"]
pub type IC_0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - 1: Do not clear the register, 0: Clear the register"]
    #[inline(always)]
    pub fn ic_0(&self) -> IC_0_R {
        IC_0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 1: Do not clear the register, 0: Clear the register"]
    #[inline(always)]
    #[must_use]
    pub fn ic_0(&mut self) -> IC_0_W<IOIRQ_3_SPEC> {
        IC_0_W::new(self, 0)
    }
