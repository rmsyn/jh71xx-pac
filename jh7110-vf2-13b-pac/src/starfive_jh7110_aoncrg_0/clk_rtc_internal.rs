...
pub type R = crate::R<CLK_RTC_INTERNAL_SPEC>;
#[doc = "Register `clk_rtc_internal` writer"]
pub type W = crate::W<CLK_RTC_INTERNAL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_RTC_INTERNAL_SPEC, 0> {
...
impl crate::Readable for CLK_RTC_INTERNAL_SPEC {}
