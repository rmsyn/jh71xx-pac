#[doc = "Register `clk_gmac0_gtx` reader"]
pub type R = crate::R<CLK_GMAC0_GTX_SPEC>;
#[doc = "Register `clk_gmac0_gtx` writer"]
pub type W = crate::W<CLK_GMAC0_GTX_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_GMAC0_GTX_SPEC, 0> {
        CLK_DIVCFG_W::new(self)
    }
    #[doc = "Bit 31 - 1: Clock enable, 0: Clock disable"]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_GMAC0_GTX_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_gmac0_gtx::R`](R) reader structure"]
impl crate::Readable for CLK_GMAC0_GTX_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_gmac0_gtx::W`](W) writer structure"]
