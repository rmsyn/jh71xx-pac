...
pub type U0_CDNS_QSPI_SCFG_SRAM_CONFIG_SLP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_CDNS_QSPI_SCFG_SRAM_CONFIG_SRAM_CONFIG_SD_W<'a, REG, const O: u8> =
...
pub type U0_CDNS_QSPI_SCFG_SRAM_CONFIG_RTSEL_W<'a, REG, const O: u8> =
...
pub type U0_CDNS_QSPI_SCFG_SRAM_CONFIG_PTSEL_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_CDNS_QSPI_SCFG_SRAM_CONFIG_TRB_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_CDNS_QSPI_SCFG_SRAM_CONFIG_WTSEL_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_CDNS_QSPI_SCFG_SRAM_CONFIG_VS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_CDNS_QSPI_SCFG_SRAM_CONFIG_VG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_SLP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_SRAM_CONFIG_SD_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
...
pub type U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_RTSEL_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_PTSEL_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_TRB_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_WTSEL_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_VS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_VG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_SDIO_DATA_STROBE_PHASE_CTRL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type U0_SDIO_HBIG_ENDIAN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn u0_cdns_qspi_scfg_sram_config_slp(
        &mut self,
    ) -> U0_CDNS_QSPI_SCFG_SRAM_CONFIG_SLP_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 0> {
        U0_CDNS_QSPI_SCFG_SRAM_CONFIG_SLP_W::new(self)
    }
    #[doc = "Bit 1 - SRAM/ROM configuration. SD: shutdown enable, high active, default is low."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_qspi_scfg_sram_config_sram_config_sd(
        &mut self,
    ) -> U0_CDNS_QSPI_SCFG_SRAM_CONFIG_SRAM_CONFIG_SD_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 1> {
        U0_CDNS_QSPI_SCFG_SRAM_CONFIG_SRAM_CONFIG_SD_W::new(self)
    }
    #[doc = "Bits 2:3 - SRAM/ROM configuration. RTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_qspi_scfg_sram_config_rtsel(
        &mut self,
    ) -> U0_CDNS_QSPI_SCFG_SRAM_CONFIG_RTSEL_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 2> {
        U0_CDNS_QSPI_SCFG_SRAM_CONFIG_RTSEL_W::new(self)
    }
    #[doc = "Bits 4:5 - SRAM/ROM configuration. PTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_qspi_scfg_sram_config_ptsel(
        &mut self,
    ) -> U0_CDNS_QSPI_SCFG_SRAM_CONFIG_PTSEL_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 4> {
        U0_CDNS_QSPI_SCFG_SRAM_CONFIG_PTSEL_W::new(self)
    }
    #[doc = "Bits 6:7 - SRAM/ROM configuration. TRB: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_qspi_scfg_sram_config_trb(
        &mut self,
    ) -> U0_CDNS_QSPI_SCFG_SRAM_CONFIG_TRB_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 6> {
        U0_CDNS_QSPI_SCFG_SRAM_CONFIG_TRB_W::new(self)
    }
    #[doc = "Bits 8:9 - SRAM/ROM configuration. WTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_qspi_scfg_sram_config_wtsel(
        &mut self,
    ) -> U0_CDNS_QSPI_SCFG_SRAM_CONFIG_WTSEL_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 8> {
        U0_CDNS_QSPI_SCFG_SRAM_CONFIG_WTSEL_W::new(self)
    }
    #[doc = "Bit 10 - SRAM/ROM configuration. VS: timing setting for debug purpose, default is 1'b1."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_qspi_scfg_sram_config_vs(
        &mut self,
    ) -> U0_CDNS_QSPI_SCFG_SRAM_CONFIG_VS_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 10> {
        U0_CDNS_QSPI_SCFG_SRAM_CONFIG_VS_W::new(self)
    }
    #[doc = "Bit 11 - SRAM/ROM configuration. VG: timing setting for debug purpose, default is 1'b1."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_qspi_scfg_sram_config_vg(
        &mut self,
    ) -> U0_CDNS_QSPI_SCFG_SRAM_CONFIG_VG_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 11> {
        U0_CDNS_QSPI_SCFG_SRAM_CONFIG_VG_W::new(self)
    }
    #[doc = "Bit 12 - SRAM/ROM configuration. SLP: sleep enable, high active, default is low."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_spdif_scfg_sram_config_slp(
        &mut self,
    ) -> U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_SLP_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 12> {
        U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_SLP_W::new(self)
    }
    #[doc = "Bit 13 - SRAM/ROM configuration. SD: shutdown enable, high active, default is low."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_spdif_scfg_sram_config_sram_config_sd(
        &mut self,
    ) -> U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_SRAM_CONFIG_SD_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 13> {
        U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_SRAM_CONFIG_SD_W::new(self)
    }
    #[doc = "Bits 14:15 - SRAM/ROM configuration. RTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_spdif_scfg_sram_config_rtsel(
        &mut self,
    ) -> U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_RTSEL_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 14> {
        U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_RTSEL_W::new(self)
    }
    #[doc = "Bits 16:17 - SRAM/ROM configuration. PTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_spdif_scfg_sram_config_ptsel(
        &mut self,
    ) -> U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_PTSEL_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 16> {
        U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_PTSEL_W::new(self)
    }
    #[doc = "Bits 18:19 - SRAM/ROM configuration. TRB: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_spdif_scfg_sram_config_trb(
        &mut self,
    ) -> U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_TRB_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 18> {
        U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_TRB_W::new(self)
    }
    #[doc = "Bits 20:21 - SRAM/ROM configuration. WTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_spdif_scfg_sram_config_wtsel(
        &mut self,
    ) -> U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_WTSEL_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 20> {
        U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_WTSEL_W::new(self)
    }
    #[doc = "Bit 22 - SRAM/ROM configuration. VS: timing setting for debug purpose, default is 1'b1."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_spdif_scfg_sram_config_vs(
        &mut self,
    ) -> U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_VS_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 22> {
        U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_VS_W::new(self)
    }
    #[doc = "Bit 23 - SRAM/ROM configuration. VG: timing setting for debug purpose, default is 1'b1."]
    #[inline(always)]
    #[must_use]
    pub fn u0_cdns_spdif_scfg_sram_config_vg(
        &mut self,
    ) -> U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_VG_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 23> {
        U0_CDNS_SPDIF_SCFG_SRAM_CONFIG_VG_W::new(self)
    }
    #[doc = "Bits 26:30 - Data strobe delay chain select"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sdio_data_strobe_phase_ctrl(
        &mut self,
    ) -> U0_SDIO_DATA_STROBE_PHASE_CTRL_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 26> {
        U0_SDIO_DATA_STROBE_PHASE_CTRL_W::new(self)
    }
    #[doc = "Bit 31 - AHB bus interface endianness: 1: Big-endian AHB bus interface, 0: Little-endian AHB bus interface"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sdio_hbig_endian(
        &mut self,
    ) -> U0_SDIO_HBIG_ENDIAN_W<SYS_SYSCONSAIF_SYSCFG20_SPEC, 31> {
        U0_SDIO_HBIG_ENDIAN_W::new(self)
    }
