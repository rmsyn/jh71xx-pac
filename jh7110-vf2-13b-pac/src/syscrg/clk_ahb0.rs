#[doc = "Register `clk_ahb0` reader"]
pub type R = crate::R<CLK_AHB0_SPEC>;
#[doc = "Register `clk_ahb0` writer"]
pub type W = crate::W<CLK_AHB0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_AHB0_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_ahb0::R`](R) reader structure"]
impl crate::Readable for CLK_AHB0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_ahb0::W`](W) writer structure"]
