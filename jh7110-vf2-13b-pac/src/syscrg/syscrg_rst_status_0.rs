#[doc = "Register `syscrg_rst_status_0` reader"]
...
#[doc = "SYSCRG RESET Status 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`syscrg_rst_status_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`syscrg_rst_status_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SYSCRG_RST_STATUS_0_SPEC;
impl crate::RegisterSpec for SYSCRG_RST_STATUS_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`syscrg_rst_status_0::R`](R) reader structure"]
impl crate::Readable for SYSCRG_RST_STATUS_0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`syscrg_rst_status_0::W`](W) writer structure"]
impl crate::Writable for SYSCRG_RST_STATUS_0_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets syscrg_rst_status_0 to value 0"]
impl crate::Resettable for SYSCRG_RST_STATUS_0_SPEC {
