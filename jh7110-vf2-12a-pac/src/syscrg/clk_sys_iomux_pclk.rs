#[doc = "Register `clk_sys_iomux_pclk` reader"]
pub type R = crate::R<CLK_SYS_IOMUX_PCLK_SPEC>;
#[doc = "Register `clk_sys_iomux_pclk` writer"]
pub type W = crate::W<CLK_SYS_IOMUX_PCLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_SYS_IOMUX_PCLK_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_sys_iomux_pclk::R`](R) reader structure"]
impl crate::Readable for CLK_SYS_IOMUX_PCLK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_sys_iomux_pclk::W`](W) writer structure"]
