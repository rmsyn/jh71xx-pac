...
pub type DMAM_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TET_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type RT_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tet(&mut self) -> TET_W<FCR_SPEC> {
        TET_W::new(self, 4)
    }
