...
impl W {
    ...
    pub fn scfg_sd1_remap_awaddr(
        &mut self,
    ) -> SCFG_SD1_REMAP_AWADDR_W<SYS_SYSCONSAIF_SYSCFG4_SPEC> {
        SCFG_SD1_REMAP_AWADDR_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - scfg_sec_haddr_remap"]
    #[inline(always)]
    #[must_use]
    pub fn scfg_sec_haddr_remap(&mut self) -> SCFG_SEC_HADDR_REMAP_W<SYS_SYSCONSAIF_SYSCFG4_SPEC> {
    ...
    pub fn scfg_usb_araddr_remap(
        &mut self,
    ) -> SCFG_USB_ARADDR_REMAP_W<SYS_SYSCONSAIF_SYSCFG4_SPEC> {
    ...
    pub fn scfg_usb_awaddr_remap(
        &mut self,
    ) -> SCFG_USB_AWADDR_REMAP_W<SYS_SYSCONSAIF_SYSCFG4_SPEC> {
    ...
    pub fn scfg_vdec_remap_awaddr(
        &mut self,
    ) -> SCFG_VDEC_REMAP_AWADDR_W<SYS_SYSCONSAIF_SYSCFG4_SPEC> {
    ...
    pub fn scfg_venc_remap_araddr(
        &mut self,
    ) -> SCFG_VENC_REMAP_ARADDR_W<SYS_SYSCONSAIF_SYSCFG4_SPEC> {
    ...
    pub fn scfg_venc_remap_awaddr(
        &mut self,
    ) -> SCFG_VENC_REMAP_AWADDR_W<SYS_SYSCONSAIF_SYSCFG4_SPEC> {
    ...
    pub fn scfg_vout0_remap_araddr(
        &mut self,
    ) -> SCFG_VOUT0_REMAP_ARADDR_W<SYS_SYSCONSAIF_SYSCFG4_SPEC> {
