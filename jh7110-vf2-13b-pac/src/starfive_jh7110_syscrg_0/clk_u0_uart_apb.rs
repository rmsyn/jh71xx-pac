#[doc = "Register `clk_u0_uart_apb` reader"]
pub type R = crate::R<CLK_U0_UART_APB_SPEC>;
#[doc = "Register `clk_u0_uart_apb` writer"]
pub type W = crate::W<CLK_U0_UART_APB_SPEC>;
...
#[doc = "`read()` method returns [`clk_u0_uart_apb::R`](R) reader structure"]
impl crate::Readable for CLK_U0_UART_APB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_uart_apb::W`](W) writer structure"]
