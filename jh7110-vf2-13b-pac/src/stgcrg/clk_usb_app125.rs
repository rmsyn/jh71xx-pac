...
pub type R = crate::R<CLK_USB_APP125_SPEC>;
#[doc = "Register `clk_usb_app125` writer"]
pub type W = crate::W<CLK_USB_APP125_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_USB_APP125_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_USB_APP125_SPEC {}
