#[doc = "Register `priority_135` reader"]
...
#[doc = "`read()` method returns [`priority_135::R`](R) reader structure"]
impl crate::Readable for PRIORITY_135_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_135::W`](W) writer structure"]
