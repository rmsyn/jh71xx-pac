#[doc = "Register `clk_axi_cfg0_dec_main` reader"]
pub type R = crate::R<CLK_AXI_CFG0_DEC_MAIN_SPEC>;
#[doc = "Register `clk_axi_cfg0_dec_main` writer"]
pub type W = crate::W<CLK_AXI_CFG0_DEC_MAIN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_AXI_CFG0_DEC_MAIN_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_axi_cfg0_dec_main::R`](R) reader structure"]
impl crate::Readable for CLK_AXI_CFG0_DEC_MAIN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_axi_cfg0_dec_main::W`](W) writer structure"]
