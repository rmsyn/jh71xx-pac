#[doc = "Register `clk_u3_spi_apb` reader"]
pub type R = crate::R<CLK_U3_SPI_APB_SPEC>;
#[doc = "Register `clk_u3_spi_apb` writer"]
pub type W = crate::W<CLK_U3_SPI_APB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U3_SPI_APB_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u3_spi_apb::R`](R) reader structure"]
impl crate::Readable for CLK_U3_SPI_APB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u3_spi_apb::W`](W) writer structure"]
