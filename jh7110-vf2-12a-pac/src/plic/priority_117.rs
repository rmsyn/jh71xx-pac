#[doc = "Register `priority_117` reader"]
...
#[doc = "`read()` method returns [`priority_117::R`](R) reader structure"]
impl crate::Readable for PRIORITY_117_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_117::W`](W) writer structure"]
