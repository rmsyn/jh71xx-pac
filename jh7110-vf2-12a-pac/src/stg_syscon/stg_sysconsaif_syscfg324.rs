...
pub type U0_PLDA_PCIE_PF2_OFFSET_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 20, O, u32>;
impl R {
...
impl W {
    ...
    pub fn u0_plda_pcie_pf2_offset(
        &mut self,
    ) -> U0_PLDA_PCIE_PF2_OFFSET_W<STG_SYSCONSAIF_SYSCFG324_SPEC, 0> {
        U0_PLDA_PCIE_PF2_OFFSET_W::new(self)
    }
