...
pub type CLR_TX_OVER_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr_tx_over(&mut self) -> CLR_TX_OVER_W<CLR_TX_OVER_SPEC, 0> {
        CLR_TX_OVER_W::new(self)
    }
...
#[doc = "DesignWare I2C Clear TX Overrun\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clr_tx_over::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clr_tx_over::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
