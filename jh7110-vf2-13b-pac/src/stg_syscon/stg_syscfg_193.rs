...
pub struct STG_SYSCFG_193_SPEC;
impl crate::RegisterSpec for STG_SYSCFG_193_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_syscfg_193::R`](R) reader structure"]
impl crate::Readable for STG_SYSCFG_193_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_syscfg_193::W`](W) writer structure"]
impl crate::Writable for STG_SYSCFG_193_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets stg_syscfg_193 to value 0"]
impl crate::Resettable for STG_SYSCFG_193_SPEC {
