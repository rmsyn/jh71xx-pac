...
pub type U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_127_96_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_axi4_slv0_aratomop_127_96(
        &mut self,
    ) -> U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_127_96_W<STG_SYSCONSAIF_SYSCFG580_SPEC, 0> {
        U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_127_96_W::new(self)
    }
