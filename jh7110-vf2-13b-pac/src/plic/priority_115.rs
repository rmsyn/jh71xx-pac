#[doc = "Register `priority_115` reader"]
...
#[doc = "`read()` method returns [`priority_115::R`](R) reader structure"]
impl crate::Readable for PRIORITY_115_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_115::W`](W) writer structure"]
