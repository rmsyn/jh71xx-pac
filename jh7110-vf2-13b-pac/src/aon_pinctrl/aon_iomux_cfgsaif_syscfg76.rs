#[doc = "Register `aon_iomux_cfgsaif_syscfg76` reader"]
pub type R = crate::R<AON_IOMUX_CFGSAIF_SYSCFG76_SPEC>;
#[doc = "Register `aon_iomux_cfgsaif_syscfg76` writer"]
pub type W = crate::W<AON_IOMUX_CFGSAIF_SYSCFG76_SPEC>;
...
impl R {
    ...
    #[inline(always)]
    pub fn padcfg_pad_rtc_ds(&self) -> PADCFG_PAD_RTC_DS_R {
        PADCFG_PAD_RTC_DS_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Output Drive Strength (DS): * 00: The rated drive strength is 2 mA. * 01: The rated drive strength is 4 mA. * 10: The rated drive strength is 8 mA. * 11: The rated drive strength is 12 mA."]
...
pub struct AON_IOMUX_CFGSAIF_SYSCFG76_SPEC;
impl crate::RegisterSpec for AON_IOMUX_CFGSAIF_SYSCFG76_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aon_iomux_cfgsaif_syscfg76::R`](R) reader structure"]
impl crate::Readable for AON_IOMUX_CFGSAIF_SYSCFG76_SPEC {}
#[doc = "`write(|w| ..)` method takes [`aon_iomux_cfgsaif_syscfg76::W`](W) writer structure"]
impl crate::Writable for AON_IOMUX_CFGSAIF_SYSCFG76_SPEC {
