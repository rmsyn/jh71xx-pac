#[doc = "Register `clk_u7mc_trace_com` reader"]
pub type R = crate::R<CLK_U7MC_TRACE_COM_SPEC>;
#[doc = "Register `clk_u7mc_trace_com` writer"]
pub type W = crate::W<CLK_U7MC_TRACE_COM_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U7MC_TRACE_COM_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u7mc_trace_com::R`](R) reader structure"]
impl crate::Readable for CLK_U7MC_TRACE_COM_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u7mc_trace_com::W`](W) writer structure"]
