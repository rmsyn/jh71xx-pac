#[doc = "Register `clk_u0_i2stx_bclk_neg` reader"]
pub type R = crate::R<CLK_U0_I2STX_BCLK_NEG_SPEC>;
#[doc = "Register `clk_u0_i2stx_bclk_neg` writer"]
pub type W = crate::W<CLK_U0_I2STX_BCLK_NEG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_polarity(&mut self) -> CLK_POLARITY_W<CLK_U0_I2STX_BCLK_NEG_SPEC, 30> {
...
#[doc = "`read()` method returns [`clk_u0_i2stx_bclk_neg::R`](R) reader structure"]
impl crate::Readable for CLK_U0_I2STX_BCLK_NEG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_i2stx_bclk_neg::W`](W) writer structure"]
