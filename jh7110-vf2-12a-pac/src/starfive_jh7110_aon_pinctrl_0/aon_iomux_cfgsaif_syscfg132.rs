#[doc = "Register `aon_iomux_cfgsaif_syscfg132` reader"]
pub type R = crate::R<AON_IOMUX_CFGSAIF_SYSCFG132_SPEC>;
#[doc = "Register `aon_iomux_cfgsaif_syscfg132` writer"]
pub type W = crate::W<AON_IOMUX_CFGSAIF_SYSCFG132_SPEC>;
...
impl R {
    ...
    #[inline(always)]
    pub fn padcfg_pad_gmac0_txd3_syscon(&self) -> PADCFG_PAD_GMAC0_TXD3_SYSCON_R {
        PADCFG_PAD_GMAC0_TXD3_SYSCON_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - padcfg_pad_gmac0_txd3_syscon"]
...
pub struct AON_IOMUX_CFGSAIF_SYSCFG132_SPEC;
impl crate::RegisterSpec for AON_IOMUX_CFGSAIF_SYSCFG132_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aon_iomux_cfgsaif_syscfg132::R`](R) reader structure"]
impl crate::Readable for AON_IOMUX_CFGSAIF_SYSCFG132_SPEC {}
#[doc = "`write(|w| ..)` method takes [`aon_iomux_cfgsaif_syscfg132::W`](W) writer structure"]
impl crate::Writable for AON_IOMUX_CFGSAIF_SYSCFG132_SPEC {
