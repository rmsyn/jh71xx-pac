...
pub type U1_PLDA_PCIE_K_PHYPARAM_607_576_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_607_576(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_607_576_W<STG_SYSCONSAIF_SYSCFG704_SPEC, 0> {
        U1_PLDA_PCIE_K_PHYPARAM_607_576_W::new(self)
    }
