#[doc = "Register `enable_4_2` reader"]
...
#[doc = "`read()` method returns [`enable_4_2::R`](R) reader structure"]
impl crate::Readable for ENABLE_4_2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`enable_4_2::W`](W) writer structure"]
