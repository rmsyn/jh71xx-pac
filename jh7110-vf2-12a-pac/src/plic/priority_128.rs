#[doc = "Register `priority_128` reader"]
...
#[doc = "`read()` method returns [`priority_128::R`](R) reader structure"]
impl crate::Readable for PRIORITY_128_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_128::W`](W) writer structure"]
