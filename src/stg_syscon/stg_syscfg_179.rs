...
pub type R = crate::R<STG_SYSCFG_179_SPEC>;
#[doc = "Register `stg_syscfg_179` writer"]
pub type W = crate::W<STG_SYSCFG_179_SPEC>;
...
pub type U1_PLDA_PCIE_K_PHYPARAM_703_672_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_703_672(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_703_672_W<STG_SYSCFG_179_SPEC> {
        U1_PLDA_PCIE_K_PHYPARAM_703_672_W::new(self, 0)
    }
...
pub struct STG_SYSCFG_179_SPEC;
impl crate::RegisterSpec for STG_SYSCFG_179_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_syscfg_179::R`](R) reader structure"]
impl crate::Readable for STG_SYSCFG_179_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_syscfg_179::W`](W) writer structure"]
impl crate::Writable for STG_SYSCFG_179_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets stg_syscfg_179 to value 0"]
impl crate::Resettable for STG_SYSCFG_179_SPEC {
