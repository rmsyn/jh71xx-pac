#[doc = "Register `clk_u0_dom_isp_top_clk_dom_isp_top_clk_isp_axi` reader"]
pub type R = crate::R<CLK_U0_DOM_ISP_TOP_CLK_DOM_ISP_TOP_CLK_ISP_AXI_SPEC>;
#[doc = "Register `clk_u0_dom_isp_top_clk_dom_isp_top_clk_isp_axi` writer"]
pub type W = crate::W<CLK_U0_DOM_ISP_TOP_CLK_DOM_ISP_TOP_CLK_ISP_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U0_DOM_ISP_TOP_CLK_DOM_ISP_TOP_CLK_ISP_AXI_SPEC> {
...
#[doc = "`read()` method returns [`clk_u0_dom_isp_top_clk_dom_isp_top_clk_isp_axi::R`](R) reader structure"]
impl crate::Readable for CLK_U0_DOM_ISP_TOP_CLK_DOM_ISP_TOP_CLK_ISP_AXI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_dom_isp_top_clk_dom_isp_top_clk_isp_axi::W`](W) writer structure"]
