...
pub type R = crate::R<CLK_APB0_SPEC>;
#[doc = "Register `clk_apb0` writer"]
pub type W = crate::W<CLK_APB0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_APB0_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_APB0_SPEC {}
