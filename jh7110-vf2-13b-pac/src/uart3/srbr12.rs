#[doc = "Register `srbr12` reader"]
pub type R = crate::R<SRBR12_SPEC>;
#[doc = "Register `srbr12` writer"]
pub type W = crate::W<SRBR12_SPEC>;
...
pub struct SRBR12_SPEC;
impl crate::RegisterSpec for SRBR12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`srbr12::R`](R) reader structure"]
impl crate::Readable for SRBR12_SPEC {}
#[doc = "`write(|w| ..)` method takes [`srbr12::W`](W) writer structure"]
impl crate::Writable for SRBR12_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets srbr12 to value 0"]
impl crate::Resettable for SRBR12_SPEC {
