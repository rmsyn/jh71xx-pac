#[doc = "Register `clk_gmac1_gtxclk` reader"]
pub type R = crate::R<CLK_GMAC1_GTXCLK_SPEC>;
#[doc = "Register `clk_gmac1_gtxclk` writer"]
pub type W = crate::W<CLK_GMAC1_GTXCLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dly_chain_sel(&mut self) -> DLY_CHAIN_SEL_W<CLK_GMAC1_GTXCLK_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_gmac1_gtxclk::R`](R) reader structure"]
impl crate::Readable for CLK_GMAC1_GTXCLK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_gmac1_gtxclk::W`](W) writer structure"]
