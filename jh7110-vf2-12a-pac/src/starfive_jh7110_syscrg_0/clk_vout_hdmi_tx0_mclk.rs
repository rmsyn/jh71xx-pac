#[doc = "Register `clk_vout_hdmi_tx0_mclk` reader"]
pub type R = crate::R<CLK_VOUT_HDMI_TX0_MCLK_SPEC>;
#[doc = "Register `clk_vout_hdmi_tx0_mclk` writer"]
pub type W = crate::W<CLK_VOUT_HDMI_TX0_MCLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_VOUT_HDMI_TX0_MCLK_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_vout_hdmi_tx0_mclk::R`](R) reader structure"]
impl crate::Readable for CLK_VOUT_HDMI_TX0_MCLK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_vout_hdmi_tx0_mclk::W`](W) writer structure"]
