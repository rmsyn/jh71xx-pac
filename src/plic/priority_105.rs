#[doc = "Register `priority_105` reader"]
...
#[doc = "`read()` method returns [`priority_105::R`](R) reader structure"]
impl crate::Readable for PRIORITY_105_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_105::W`](W) writer structure"]
