...
pub type U0_DOM_VOUT_TOP_U0_HDMI_TX_PIN_HPD_CFG_W<'a, REG, const O: u8> =
...
pub type U0_I2C_IC_CLK_IN_A_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U0_I2C_IC_DATA_IN_A_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U0_SDIO_CARD_DETECT_N_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
...
impl W {
    ...
    pub fn u0_dom_vout_top_u0_hdmi_tx_pin_hpd_cfg(
        &mut self,
    ) -> U0_DOM_VOUT_TOP_U0_HDMI_TX_PIN_HPD_CFG_W<GPI8_SPEC, 0> {
        U0_DOM_VOUT_TOP_U0_HDMI_TX_PIN_HPD_CFG_W::new(self)
    }
    #[doc = "Bits 8:14 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u0_i2c_ic_clk_in_a_cfg(&mut self) -> U0_I2C_IC_CLK_IN_A_CFG_W<GPI8_SPEC, 8> {
        U0_I2C_IC_CLK_IN_A_CFG_W::new(self)
    }
    #[doc = "Bits 16:22 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u0_i2c_ic_data_in_a_cfg(&mut self) -> U0_I2C_IC_DATA_IN_A_CFG_W<GPI8_SPEC, 16> {
        U0_I2C_IC_DATA_IN_A_CFG_W::new(self)
    }
    #[doc = "Bits 24:30 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u0_sdio_card_detect_n_cfg(&mut self) -> U0_SDIO_CARD_DETECT_N_CFG_W<GPI8_SPEC, 24> {
        U0_SDIO_CARD_DETECT_N_CFG_W::new(self)
    }
