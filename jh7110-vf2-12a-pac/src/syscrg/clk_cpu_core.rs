#[doc = "Register `clk_cpu_core` reader"]
pub type R = crate::R<CLK_CPU_CORE_SPEC>;
#[doc = "Register `clk_cpu_core` writer"]
pub type W = crate::W<CLK_CPU_CORE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_CPU_CORE_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_cpu_core::R`](R) reader structure"]
impl crate::Readable for CLK_CPU_CORE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_cpu_core::W`](W) writer structure"]
