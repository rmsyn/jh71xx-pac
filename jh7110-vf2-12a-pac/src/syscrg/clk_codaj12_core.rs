#[doc = "Register `clk_codaj12_core` reader"]
pub type R = crate::R<CLK_CODAJ12_CORE_SPEC>;
#[doc = "Register `clk_codaj12_core` writer"]
pub type W = crate::W<CLK_CODAJ12_CORE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_CODAJ12_CORE_SPEC, 0> {
        CLK_DIVCFG_W::new(self)
    }
    #[doc = "Bit 31 - 1: Clock enable, 0: Clock disable"]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_CODAJ12_CORE_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_codaj12_core::R`](R) reader structure"]
impl crate::Readable for CLK_CODAJ12_CORE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_codaj12_core::W`](W) writer structure"]
