...
pub type U1_PLDA_PCIE_K_PHYPARAM_479_448_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_479_448(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_479_448_W<STG_SYSCONSAIF_SYSCFG688_SPEC, 0> {
        U1_PLDA_PCIE_K_PHYPARAM_479_448_W::new(self)
    }
