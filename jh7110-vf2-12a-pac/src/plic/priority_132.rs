#[doc = "Register `priority_132` reader"]
...
#[doc = "`read()` method returns [`priority_132::R`](R) reader structure"]
impl crate::Readable for PRIORITY_132_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_132::W`](W) writer structure"]
