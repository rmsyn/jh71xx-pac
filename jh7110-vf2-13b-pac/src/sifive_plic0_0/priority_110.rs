#[doc = "Register `priority_110` reader"]
...
#[doc = "`read()` method returns [`priority_110::R`](R) reader structure"]
impl crate::Readable for PRIORITY_110_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_110::W`](W) writer structure"]
