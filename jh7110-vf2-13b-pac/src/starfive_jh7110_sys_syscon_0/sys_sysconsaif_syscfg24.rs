...
pub type U0_SDIO_M_HBIG_ENDIAN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_I2SRX_3CH_ADC_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_INTMEM_ROM_SRAM_SCFG_DISABLE_ROM_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_INTMEM_ROM_SRAM_SRAM_CONFIG_SLP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_INTMEM_ROM_SRAM_SRAM_CONFIG_SRAM_CONFIG_SD_W<'a, REG, const O: u8> =
...
pub type U0_INTMEM_ROM_SRAM_SRAM_CONFIG_RTSEL_W<'a, REG, const O: u8> =
...
pub type U0_INTMEM_ROM_SRAM_SRAM_CONFIG_PTSEL_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_INTMEM_ROM_SRAM_SRAM_CONFIG_TRB_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_INTMEM_ROM_SRAM_SRAM_CONFIG_WTSEL_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_INTMEM_ROM_SRAM_SRAM_CONFIG_VS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_INTMEM_ROM_SRAM_SRAM_CONFIG_VG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_JTAG_DAISY_CHAIN_JTAG_EN_0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_JTAG_DAISY_CHAIN_JTAG_EN_1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PDRSTN_SPLIT_SW_USBPIPE_PLUGEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLL_WRAP_PLL0_CPI_BIAS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type U0_PLL_WRAP_PLL0_CPP_BIAS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type U0_PLL_WRAP_PLL0_DACPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLL_WRAP_PLL0_DSMPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn u0_sdio_m_hbig_endian(
        &mut self,
    ) -> U0_SDIO_M_HBIG_ENDIAN_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 0> {
        U0_SDIO_M_HBIG_ENDIAN_W::new(self)
    }
    #[doc = "Bit 1 - u0_i2srx_3ch_adc_ena"]
    #[inline(always)]
    #[must_use]
    pub fn u0_i2srx_3ch_adc_ena(
        &mut self,
    ) -> U0_I2SRX_3CH_ADC_ENA_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 1> {
        U0_I2SRX_3CH_ADC_ENA_W::new(self)
    }
    #[doc = "Bit 2 - u0_intmem_rom_sram_scfg_disable_rom"]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_scfg_disable_rom(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SCFG_DISABLE_ROM_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 2> {
        U0_INTMEM_ROM_SRAM_SCFG_DISABLE_ROM_W::new(self)
    }
    #[doc = "Bit 3 - SRAM/ROM configuration. SLP: sleep enable, high active, default is low."]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_sram_config_slp(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SRAM_CONFIG_SLP_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 3> {
        U0_INTMEM_ROM_SRAM_SRAM_CONFIG_SLP_W::new(self)
    }
    #[doc = "Bit 4 - SRAM/ROM configuration. SD: shutdown enable, high active, default is low."]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_sram_config_sram_config_sd(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SRAM_CONFIG_SRAM_CONFIG_SD_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 4> {
        U0_INTMEM_ROM_SRAM_SRAM_CONFIG_SRAM_CONFIG_SD_W::new(self)
    }
    #[doc = "Bits 5:6 - SRAM/ROM configuration. RTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_sram_config_rtsel(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SRAM_CONFIG_RTSEL_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 5> {
        U0_INTMEM_ROM_SRAM_SRAM_CONFIG_RTSEL_W::new(self)
    }
    #[doc = "Bits 7:8 - SRAM/ROM configuration. PTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_sram_config_ptsel(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SRAM_CONFIG_PTSEL_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 7> {
        U0_INTMEM_ROM_SRAM_SRAM_CONFIG_PTSEL_W::new(self)
    }
    #[doc = "Bits 9:10 - SRAM/ROM configuration. TRB: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_sram_config_trb(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SRAM_CONFIG_TRB_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 9> {
        U0_INTMEM_ROM_SRAM_SRAM_CONFIG_TRB_W::new(self)
    }
    #[doc = "Bits 11:12 - SRAM/ROM configuration. WTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_sram_config_wtsel(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SRAM_CONFIG_WTSEL_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 11> {
        U0_INTMEM_ROM_SRAM_SRAM_CONFIG_WTSEL_W::new(self)
    }
    #[doc = "Bit 13 - SRAM/ROM configuration. VS: timing setting for debug purpose, default is 1'b1."]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_sram_config_vs(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SRAM_CONFIG_VS_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 13> {
        U0_INTMEM_ROM_SRAM_SRAM_CONFIG_VS_W::new(self)
    }
    #[doc = "Bit 14 - SRAM/ROM configuration. VG: timing setting for debug purpose, default is 1'b1."]
    #[inline(always)]
    #[must_use]
    pub fn u0_intmem_rom_sram_sram_config_vg(
        &mut self,
    ) -> U0_INTMEM_ROM_SRAM_SRAM_CONFIG_VG_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 14> {
        U0_INTMEM_ROM_SRAM_SRAM_CONFIG_VG_W::new(self)
    }
    #[doc = "Bit 15 - u0_jtag_daisy_chain_jtag_en_0"]
    #[inline(always)]
    #[must_use]
    pub fn u0_jtag_daisy_chain_jtag_en_0(
        &mut self,
    ) -> U0_JTAG_DAISY_CHAIN_JTAG_EN_0_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 15> {
        U0_JTAG_DAISY_CHAIN_JTAG_EN_0_W::new(self)
    }
    #[doc = "Bit 16 - u0_jtag_daisy_chain_jtag_en_1"]
    #[inline(always)]
    #[must_use]
    pub fn u0_jtag_daisy_chain_jtag_en_1(
        &mut self,
    ) -> U0_JTAG_DAISY_CHAIN_JTAG_EN_1_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 16> {
        U0_JTAG_DAISY_CHAIN_JTAG_EN_1_W::new(self)
    }
    #[doc = "Bit 17 - u0_pdrstn_split_sw_usbpipe_plugen"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pdrstn_split_sw_usbpipe_plugen(
        &mut self,
    ) -> U0_PDRSTN_SPLIT_SW_USBPIPE_PLUGEN_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 17> {
        U0_PDRSTN_SPLIT_SW_USBPIPE_PLUGEN_W::new(self)
    }
    #[doc = "Bits 18:20 - u0_pll_wrap_pll0_cpi_bias"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll0_cpi_bias(
        &mut self,
    ) -> U0_PLL_WRAP_PLL0_CPI_BIAS_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 18> {
        U0_PLL_WRAP_PLL0_CPI_BIAS_W::new(self)
    }
    #[doc = "Bits 21:23 - u0_pll_wrap_pll0_cpp_bias"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll0_cpp_bias(
        &mut self,
    ) -> U0_PLL_WRAP_PLL0_CPP_BIAS_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 21> {
        U0_PLL_WRAP_PLL0_CPP_BIAS_W::new(self)
    }
    #[doc = "Bit 24 - u0_pll_wrap_pll0_dacpd"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll0_dacpd(
        &mut self,
    ) -> U0_PLL_WRAP_PLL0_DACPD_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 24> {
        U0_PLL_WRAP_PLL0_DACPD_W::new(self)
    }
    #[doc = "Bit 25 - u0_pll_wrap_pll0_dsmpd"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll0_dsmpd(
        &mut self,
    ) -> U0_PLL_WRAP_PLL0_DSMPD_W<SYS_SYSCONSAIF_SYSCFG24_SPEC, 25> {
        U0_PLL_WRAP_PLL0_DSMPD_W::new(self)
    }
