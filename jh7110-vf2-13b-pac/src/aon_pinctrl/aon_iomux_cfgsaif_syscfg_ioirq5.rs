...
pub type AON_GPIOIC_0_REG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aon_gpioic_0_reg(
        &mut self,
    ) -> AON_GPIOIC_0_REG_W<AON_IOMUX_CFGSAIF_SYSCFG_IOIRQ5_SPEC, 0> {
        AON_GPIOIC_0_REG_W::new(self)
    }
