#[doc = "Register `enable_3_3` reader"]
...
#[doc = "`read()` method returns [`enable_3_3::R`](R) reader structure"]
impl crate::Readable for ENABLE_3_3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`enable_3_3::W`](W) writer structure"]
