#[doc = "Register `priority_80` reader"]
...
#[doc = "`read()` method returns [`priority_80::R`](R) reader structure"]
impl crate::Readable for PRIORITY_80_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_80::W`](W) writer structure"]
