...
pub type U0_U7MC_SFT7110_RESET_VECTOR_3_35_32_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_u7mc_sft7110_reset_vector_3_35_32(
        &mut self,
    ) -> U0_U7MC_SFT7110_RESET_VECTOR_3_35_32_W<SYS_SYSCONSAIF_SYSCFG124_SPEC, 0> {
        U0_U7MC_SFT7110_RESET_VECTOR_3_35_32_W::new(self)
    }
