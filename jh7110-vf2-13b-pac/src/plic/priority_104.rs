#[doc = "Register `priority_104` reader"]
...
#[doc = "`read()` method returns [`priority_104::R`](R) reader structure"]
impl crate::Readable for PRIORITY_104_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_104::W`](W) writer structure"]
