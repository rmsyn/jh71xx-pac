...
pub type R = crate::R<STG_SYSCFG_11_SPEC>;
#[doc = "Register `stg_syscfg_11` writer"]
pub type W = crate::W<STG_SYSCFG_11_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn u0_hifi4_altresetvec(&mut self) -> U0_HIFI4_ALTRESETVEC_W<STG_SYSCFG_11_SPEC> {
...
pub struct STG_SYSCFG_11_SPEC;
impl crate::RegisterSpec for STG_SYSCFG_11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_syscfg_11::R`](R) reader structure"]
impl crate::Readable for STG_SYSCFG_11_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_syscfg_11::W`](W) writer structure"]
impl crate::Writable for STG_SYSCFG_11_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets stg_syscfg_11 to value 0"]
impl crate::Resettable for STG_SYSCFG_11_SPEC {
