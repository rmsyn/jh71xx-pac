...
pub type U1_PLDA_PCIE_K_PHYPARAM_735_704_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_735_704(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_735_704_W<STG_SYSCONSAIF_SYSCFG720_SPEC, 0> {
        U1_PLDA_PCIE_K_PHYPARAM_735_704_W::new(self)
    }
