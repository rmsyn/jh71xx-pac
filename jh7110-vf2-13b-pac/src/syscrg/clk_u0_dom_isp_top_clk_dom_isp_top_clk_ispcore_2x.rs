#[doc = "Register `clk_u0_dom_isp_top_clk_dom_isp_top_clk_ispcore_2x` reader"]
pub type R = crate::R<CLK_U0_DOM_ISP_TOP_CLK_DOM_ISP_TOP_CLK_ISPCORE_2X_SPEC>;
#[doc = "Register `clk_u0_dom_isp_top_clk_dom_isp_top_clk_ispcore_2x` writer"]
pub type W = crate::W<CLK_U0_DOM_ISP_TOP_CLK_DOM_ISP_TOP_CLK_ISPCORE_2X_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U0_DOM_ISP_TOP_CLK_DOM_ISP_TOP_CLK_ISPCORE_2X_SPEC> {
...
#[doc = "`read()` method returns [`clk_u0_dom_isp_top_clk_dom_isp_top_clk_ispcore_2x::R`](R) reader structure"]
impl crate::Readable for CLK_U0_DOM_ISP_TOP_CLK_DOM_ISP_TOP_CLK_ISPCORE_2X_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_dom_isp_top_clk_dom_isp_top_clk_ispcore_2x::W`](W) writer structure"]
