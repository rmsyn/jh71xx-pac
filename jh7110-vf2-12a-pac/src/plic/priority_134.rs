#[doc = "Register `priority_134` reader"]
...
#[doc = "`read()` method returns [`priority_134::R`](R) reader structure"]
impl crate::Readable for PRIORITY_134_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_134::W`](W) writer structure"]
