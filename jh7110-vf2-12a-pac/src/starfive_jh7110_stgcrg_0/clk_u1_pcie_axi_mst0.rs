#[doc = "Register `clk_u1_pcie_axi_mst0` reader"]
pub type R = crate::R<CLK_U1_PCIE_AXI_MST0_SPEC>;
#[doc = "Register `clk_u1_pcie_axi_mst0` writer"]
pub type W = crate::W<CLK_U1_PCIE_AXI_MST0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U1_PCIE_AXI_MST0_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u1_pcie_axi_mst0::R`](R) reader structure"]
impl crate::Readable for CLK_U1_PCIE_AXI_MST0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u1_pcie_axi_mst0::W`](W) writer structure"]
