...
pub type R = crate::R<CLK_GCLK1_SPEC>;
#[doc = "Register `clk_gclk1` writer"]
pub type W = crate::W<CLK_GCLK1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_GCLK1_SPEC, 0> {
        CLK_DIVCFG_W::new(self)
    }
    #[doc = "Bit 31 - 1: Clock enable, 0: Clock disable"]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_GCLK1_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_GCLK1_SPEC {}
