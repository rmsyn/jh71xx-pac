#[doc = "Register `priority_97` reader"]
...
#[doc = "`read()` method returns [`priority_97::R`](R) reader structure"]
impl crate::Readable for PRIORITY_97_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_97::W`](W) writer structure"]
