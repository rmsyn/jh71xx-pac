#[doc = "Register `clk_u1_uart_apb` reader"]
pub type R = crate::R<CLK_U1_UART_APB_SPEC>;
#[doc = "Register `clk_u1_uart_apb` writer"]
pub type W = crate::W<CLK_U1_UART_APB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U1_UART_APB_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u1_uart_apb::R`](R) reader structure"]
impl crate::Readable for CLK_U1_UART_APB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u1_uart_apb::W`](W) writer structure"]
