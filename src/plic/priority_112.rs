#[doc = "Register `priority_112` reader"]
...
#[doc = "`read()` method returns [`priority_112::R`](R) reader structure"]
impl crate::Readable for PRIORITY_112_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_112::W`](W) writer structure"]
