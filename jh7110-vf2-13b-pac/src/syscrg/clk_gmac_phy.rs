#[doc = "Register `clk_gmac_phy` reader"]
pub type R = crate::R<CLK_GMAC_PHY_SPEC>;
#[doc = "Register `clk_gmac_phy` writer"]
pub type W = crate::W<CLK_GMAC_PHY_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_GMAC_PHY_SPEC, 0> {
        CLK_DIVCFG_W::new(self)
    }
    #[doc = "Bit 31 - 1: Clock enable, 0: Clock disable"]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_GMAC_PHY_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_gmac_phy::R`](R) reader structure"]
impl crate::Readable for CLK_GMAC_PHY_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_gmac_phy::W`](W) writer structure"]
