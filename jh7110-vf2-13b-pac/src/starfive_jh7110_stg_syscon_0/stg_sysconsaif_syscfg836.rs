...
pub type U1_PLDA_PCIE_TEST_OUT_BRIDGE_351_320_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_test_out_bridge_351_320(
        &mut self,
    ) -> U1_PLDA_PCIE_TEST_OUT_BRIDGE_351_320_W<STG_SYSCONSAIF_SYSCFG836_SPEC, 0> {
        U1_PLDA_PCIE_TEST_OUT_BRIDGE_351_320_W::new(self)
    }
