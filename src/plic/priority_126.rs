#[doc = "Register `priority_126` reader"]
...
#[doc = "`read()` method returns [`priority_126::R`](R) reader structure"]
impl crate::Readable for PRIORITY_126_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_126::W`](W) writer structure"]
