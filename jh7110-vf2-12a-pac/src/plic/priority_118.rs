#[doc = "Register `priority_118` reader"]
...
#[doc = "`read()` method returns [`priority_118::R`](R) reader structure"]
impl crate::Readable for PRIORITY_118_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_118::W`](W) writer structure"]
