#[doc = "Register `priority_106` reader"]
...
#[doc = "`read()` method returns [`priority_106::R`](R) reader structure"]
impl crate::Readable for PRIORITY_106_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_106::W`](W) writer structure"]
