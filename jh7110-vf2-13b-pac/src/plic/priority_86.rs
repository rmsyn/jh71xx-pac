#[doc = "Register `priority_86` reader"]
...
#[doc = "`read()` method returns [`priority_86::R`](R) reader structure"]
impl crate::Readable for PRIORITY_86_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_86::W`](W) writer structure"]
