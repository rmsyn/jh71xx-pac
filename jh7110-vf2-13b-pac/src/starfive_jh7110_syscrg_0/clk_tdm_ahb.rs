#[doc = "Register `clk_tdm_ahb` reader"]
pub type R = crate::R<CLK_TDM_AHB_SPEC>;
#[doc = "Register `clk_tdm_ahb` writer"]
pub type W = crate::W<CLK_TDM_AHB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_TDM_AHB_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_tdm_ahb::R`](R) reader structure"]
impl crate::Readable for CLK_TDM_AHB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_tdm_ahb::W`](W) writer structure"]
