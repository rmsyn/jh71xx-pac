...
pub type AON_GPIOIE_0_REG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aon_gpioie_0_reg(
        &mut self,
    ) -> AON_GPIOIE_0_REG_W<AON_IOMUX_CFGSAIF_SYSCFG_IOIRQ8_SPEC, 0> {
        AON_GPIOIE_0_REG_W::new(self)
    }
