#[doc = "Register `clk_u0_sft7110_noc_bus_clk_gpu_axi` reader"]
pub type R = crate::R<CLK_U0_SFT7110_NOC_BUS_CLK_GPU_AXI_SPEC>;
#[doc = "Register `clk_u0_sft7110_noc_bus_clk_gpu_axi` writer"]
pub type W = crate::W<CLK_U0_SFT7110_NOC_BUS_CLK_GPU_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U0_SFT7110_NOC_BUS_CLK_GPU_AXI_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u0_sft7110_noc_bus_clk_gpu_axi::R`](R) reader structure"]
impl crate::Readable for CLK_U0_SFT7110_NOC_BUS_CLK_GPU_AXI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_sft7110_noc_bus_clk_gpu_axi::W`](W) writer structure"]
