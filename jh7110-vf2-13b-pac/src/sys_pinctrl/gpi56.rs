...
pub type U1_SSP_SPI_SSP_CLKIN_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U1_SSP_SPI_SSPFSSIN_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U1_SSP_SPI_SSPRXD_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U2_I2C_IC_CLK_IN_A_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn u1_ssp_spi_ssp_clkin_cfg(&mut self) -> U1_SSP_SPI_SSP_CLKIN_CFG_W<GPI56_SPEC, 0> {
        U1_SSP_SPI_SSP_CLKIN_CFG_W::new(self)
    }
    #[doc = "Bits 8:14 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u1_ssp_spi_sspfssin_cfg(&mut self) -> U1_SSP_SPI_SSPFSSIN_CFG_W<GPI56_SPEC, 8> {
        U1_SSP_SPI_SSPFSSIN_CFG_W::new(self)
    }
    #[doc = "Bits 16:22 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u1_ssp_spi_ssprxd_cfg(&mut self) -> U1_SSP_SPI_SSPRXD_CFG_W<GPI56_SPEC, 16> {
        U1_SSP_SPI_SSPRXD_CFG_W::new(self)
    }
    #[doc = "Bits 24:30 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u2_i2c_ic_clk_in_a_cfg(&mut self) -> U2_I2C_IC_CLK_IN_A_CFG_W<GPI56_SPEC, 24> {
        U2_I2C_IC_CLK_IN_A_CFG_W::new(self)
    }
