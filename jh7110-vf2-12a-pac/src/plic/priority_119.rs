#[doc = "Register `priority_119` reader"]
...
#[doc = "`read()` method returns [`priority_119::R`](R) reader structure"]
impl crate::Readable for PRIORITY_119_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_119::W`](W) writer structure"]
