...
pub type U0_PLDA_PCIE_K_PHYPARAM_127_96_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_plda_pcie_k_phyparam_127_96(
        &mut self,
    ) -> U0_PLDA_PCIE_K_PHYPARAM_127_96_W<STG_SYSCONSAIF_SYSCFG212_SPEC, 0> {
        U0_PLDA_PCIE_K_PHYPARAM_127_96_W::new(self)
    }
