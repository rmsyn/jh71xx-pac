#[doc = "Register `aon_iomux_cfgsaif_syscfg100` reader"]
pub type R = crate::R<AON_IOMUX_CFGSAIF_SYSCFG100_SPEC>;
#[doc = "Register `aon_iomux_cfgsaif_syscfg100` writer"]
pub type W = crate::W<AON_IOMUX_CFGSAIF_SYSCFG100_SPEC>;
...
impl R {
    ...
    #[inline(always)]
    pub fn padcfg_pad_gmac0_rxd1_syscon(&self) -> PADCFG_PAD_GMAC0_RXD1_SYSCON_R {
        PADCFG_PAD_GMAC0_RXD1_SYSCON_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - padcfg_pad_gmac0_rxd1_syscon"]
...
pub struct AON_IOMUX_CFGSAIF_SYSCFG100_SPEC;
impl crate::RegisterSpec for AON_IOMUX_CFGSAIF_SYSCFG100_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aon_iomux_cfgsaif_syscfg100::R`](R) reader structure"]
impl crate::Readable for AON_IOMUX_CFGSAIF_SYSCFG100_SPEC {}
#[doc = "`write(|w| ..)` method takes [`aon_iomux_cfgsaif_syscfg100::W`](W) writer structure"]
impl crate::Writable for AON_IOMUX_CFGSAIF_SYSCFG100_SPEC {
