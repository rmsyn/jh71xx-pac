...
pub type U0_U7MC_SFT7110_RESET_VECTOR_1_31_0_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_u7mc_sft7110_reset_vector_1_31_0(
        &mut self,
    ) -> U0_U7MC_SFT7110_RESET_VECTOR_1_31_0_W<SYS_SYSCONSAIF_SYSCFG104_SPEC, 0> {
        U0_U7MC_SFT7110_RESET_VECTOR_1_31_0_W::new(self)
    }
