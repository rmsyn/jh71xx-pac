...
pub type U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_31_0_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_axi4_slv0_aratomop_31_0(
        &mut self,
    ) -> U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_31_0_W<STG_SYSCONSAIF_SYSCFG568_SPEC, 0> {
        U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_31_0_W::new(self)
    }
