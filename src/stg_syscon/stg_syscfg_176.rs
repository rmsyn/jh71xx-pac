...
pub type R = crate::R<STG_SYSCFG_176_SPEC>;
#[doc = "Register `stg_syscfg_176` writer"]
pub type W = crate::W<STG_SYSCFG_176_SPEC>;
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_607_576(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_607_576_W<STG_SYSCFG_176_SPEC> {
...
pub struct STG_SYSCFG_176_SPEC;
impl crate::RegisterSpec for STG_SYSCFG_176_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_syscfg_176::R`](R) reader structure"]
impl crate::Readable for STG_SYSCFG_176_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_syscfg_176::W`](W) writer structure"]
impl crate::Writable for STG_SYSCFG_176_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets stg_syscfg_176 to value 0"]
impl crate::Resettable for STG_SYSCFG_176_SPEC {
