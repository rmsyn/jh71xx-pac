#[doc = "Register `clk_venc_axi` reader"]
pub type R = crate::R<CLK_VENC_AXI_SPEC>;
#[doc = "Register `clk_venc_axi` writer"]
pub type W = crate::W<CLK_VENC_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_VENC_AXI_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_venc_axi::R`](R) reader structure"]
impl crate::Readable for CLK_VENC_AXI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_venc_axi::W`](W) writer structure"]
