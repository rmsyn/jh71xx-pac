#[doc = "Register `clk_gmac5_axi64_axi` reader"]
pub type R = crate::R<CLK_GMAC5_AXI64_AXI_SPEC>;
#[doc = "Register `clk_gmac5_axi64_axi` writer"]
pub type W = crate::W<CLK_GMAC5_AXI64_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_GMAC5_AXI64_AXI_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_gmac5_axi64_axi::R`](R) reader structure"]
impl crate::Readable for CLK_GMAC5_AXI64_AXI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_gmac5_axi64_axi::W`](W) writer structure"]
