#[doc = "Register `priority_91` reader"]
...
#[doc = "`read()` method returns [`priority_91::R`](R) reader structure"]
impl crate::Readable for PRIORITY_91_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_91::W`](W) writer structure"]
