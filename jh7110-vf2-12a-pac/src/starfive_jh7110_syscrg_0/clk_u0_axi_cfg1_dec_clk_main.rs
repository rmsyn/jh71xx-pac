#[doc = "Register `clk_u0_axi_cfg1_dec_clk_main` reader"]
pub type R = crate::R<CLK_U0_AXI_CFG1_DEC_CLK_MAIN_SPEC>;
#[doc = "Register `clk_u0_axi_cfg1_dec_clk_main` writer"]
pub type W = crate::W<CLK_U0_AXI_CFG1_DEC_CLK_MAIN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U0_AXI_CFG1_DEC_CLK_MAIN_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u0_axi_cfg1_dec_clk_main::R`](R) reader structure"]
impl crate::Readable for CLK_U0_AXI_CFG1_DEC_CLK_MAIN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_axi_cfg1_dec_clk_main::W`](W) writer structure"]
