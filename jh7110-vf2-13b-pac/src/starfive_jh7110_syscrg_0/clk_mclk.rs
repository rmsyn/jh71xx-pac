#[doc = "Register `clk_mclk` reader"]
pub type R = crate::R<CLK_MCLK_SPEC>;
#[doc = "Register `clk_mclk` writer"]
pub type W = crate::W<CLK_MCLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_mux_sel(&mut self) -> CLK_MUX_SEL_W<CLK_MCLK_SPEC, 24> {
...
#[doc = "`read()` method returns [`clk_mclk::R`](R) reader structure"]
impl crate::Readable for CLK_MCLK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_mclk::W`](W) writer structure"]
