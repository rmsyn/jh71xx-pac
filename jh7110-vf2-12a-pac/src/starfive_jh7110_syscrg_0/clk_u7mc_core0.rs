#[doc = "Register `clk_u7mc_core0` reader"]
pub type R = crate::R<CLK_U7MC_CORE0_SPEC>;
#[doc = "Register `clk_u7mc_core0` writer"]
pub type W = crate::W<CLK_U7MC_CORE0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U7MC_CORE0_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u7mc_core0::R`](R) reader structure"]
impl crate::Readable for CLK_U7MC_CORE0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u7mc_core0::W`](W) writer structure"]
