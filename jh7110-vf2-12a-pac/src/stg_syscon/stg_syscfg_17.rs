...
pub type R = crate::R<STG_SYSCFG_17_SPEC>;
#[doc = "Register `stg_syscfg_17` writer"]
pub type W = crate::W<STG_SYSCFG_17_SPEC>;
...
pub type U0_HIFI4_SCFG_SRAM_CONFIG_SD_R = crate::BitReader;
#[doc = "Field `u0_hifi4_scfg_sram_config_sd` writer - SRAM/ROM configuration. SD: shutdown enable, high active, default is low."]
pub type U0_HIFI4_SCFG_SRAM_CONFIG_SD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn u0_hifi4_scfg_sram_config_sd(&self) -> U0_HIFI4_SCFG_SRAM_CONFIG_SD_R {
        U0_HIFI4_SCFG_SRAM_CONFIG_SD_R::new(((self.bits >> 1) & 1) != 0)
    }
...
impl W {
    ...
    pub fn u0_hifi4_scfg_sram_config_slp(
        &mut self,
    ) -> U0_HIFI4_SCFG_SRAM_CONFIG_SLP_W<STG_SYSCFG_17_SPEC> {
        U0_HIFI4_SCFG_SRAM_CONFIG_SLP_W::new(self, 0)
    }
    #[doc = "Bit 1 - SRAM/ROM configuration. SD: shutdown enable, high active, default is low."]
    #[inline(always)]
    #[must_use]
    pub fn u0_hifi4_scfg_sram_config_sd(
        &mut self,
    ) -> U0_HIFI4_SCFG_SRAM_CONFIG_SD_W<STG_SYSCFG_17_SPEC> {
        U0_HIFI4_SCFG_SRAM_CONFIG_SD_W::new(self, 1)
    }
    #[doc = "Bits 2:3 - SRAM/ROM configuration. RTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_hifi4_scfg_sram_config_rtsel(
        &mut self,
    ) -> U0_HIFI4_SCFG_SRAM_CONFIG_RTSEL_W<STG_SYSCFG_17_SPEC> {
    ...
    pub fn u0_hifi4_scfg_sram_config_ptsel(
        &mut self,
    ) -> U0_HIFI4_SCFG_SRAM_CONFIG_PTSEL_W<STG_SYSCFG_17_SPEC> {
    ...
    pub fn u0_hifi4_scfg_sram_config_trb(
        &mut self,
    ) -> U0_HIFI4_SCFG_SRAM_CONFIG_TRB_W<STG_SYSCFG_17_SPEC> {
    ...
    pub fn u0_hifi4_scfg_sram_config_wtsel(
        &mut self,
    ) -> U0_HIFI4_SCFG_SRAM_CONFIG_WTSEL_W<STG_SYSCFG_17_SPEC> {
    ...
    pub fn u0_hifi4_scfg_sram_config_vs(
        &mut self,
    ) -> U0_HIFI4_SCFG_SRAM_CONFIG_VS_W<STG_SYSCFG_17_SPEC> {
    ...
    pub fn u0_hifi4_scfg_sram_config_vg(
        &mut self,
    ) -> U0_HIFI4_SCFG_SRAM_CONFIG_VG_W<STG_SYSCFG_17_SPEC> {
        U0_HIFI4_SCFG_SRAM_CONFIG_VG_W::new(self, 11)
    }
    #[doc = "Bit 12 - When the value is 1, it indicates that the AltResetVec is valid"]
    #[inline(always)]
    #[must_use]
    pub fn u0_hifi4_statvectorsel(&mut self) -> U0_HIFI4_STATVECTORSEL_W<STG_SYSCFG_17_SPEC> {
        U0_HIFI4_STATVECTORSEL_W::new(self, 12)
    }
    #[doc = "Bit 13 - DMA port trigger"]
    #[inline(always)]
    #[must_use]
    pub fn u0_hifi4_trigin_idma(&mut self) -> U0_HIFI4_TRIGIN_IDMA_W<STG_SYSCFG_17_SPEC> {
...
pub struct STG_SYSCFG_17_SPEC;
impl crate::RegisterSpec for STG_SYSCFG_17_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_syscfg_17::R`](R) reader structure"]
impl crate::Readable for STG_SYSCFG_17_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_syscfg_17::W`](W) writer structure"]
impl crate::Writable for STG_SYSCFG_17_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets stg_syscfg_17 to value 0"]
impl crate::Resettable for STG_SYSCFG_17_SPEC {
