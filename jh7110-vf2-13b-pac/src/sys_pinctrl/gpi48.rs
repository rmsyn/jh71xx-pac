...
pub type U1_SDIO_CDATA_IN_3_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U1_SDIO_CDATA_IN_4_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U1_SDIO_CDATA_IN_5_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U1_SDIO_CDATA_IN_6_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn u1_sdio_cdata_in_3_cfg(&mut self) -> U1_SDIO_CDATA_IN_3_CFG_W<GPI48_SPEC, 0> {
        U1_SDIO_CDATA_IN_3_CFG_W::new(self)
    }
    #[doc = "Bits 8:14 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u1_sdio_cdata_in_4_cfg(&mut self) -> U1_SDIO_CDATA_IN_4_CFG_W<GPI48_SPEC, 8> {
        U1_SDIO_CDATA_IN_4_CFG_W::new(self)
    }
    #[doc = "Bits 16:22 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u1_sdio_cdata_in_5_cfg(&mut self) -> U1_SDIO_CDATA_IN_5_CFG_W<GPI48_SPEC, 16> {
        U1_SDIO_CDATA_IN_5_CFG_W::new(self)
    }
    #[doc = "Bits 24:30 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u1_sdio_cdata_in_6_cfg(&mut self) -> U1_SDIO_CDATA_IN_6_CFG_W<GPI48_SPEC, 24> {
        U1_SDIO_CDATA_IN_6_CFG_W::new(self)
    }
