#[doc = "Register `clk_wave420l_axi` reader"]
pub type R = crate::R<CLK_WAVE420L_AXI_SPEC>;
#[doc = "Register `clk_wave420l_axi` writer"]
pub type W = crate::W<CLK_WAVE420L_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_WAVE420L_AXI_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_wave420l_axi::R`](R) reader structure"]
impl crate::Readable for CLK_WAVE420L_AXI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_wave420l_axi::W`](W) writer structure"]
