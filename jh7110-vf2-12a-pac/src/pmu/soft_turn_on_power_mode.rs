...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn systop_power_mode(&mut self) -> SYSTOP_POWER_MODE_W<SOFT_TURN_ON_POWER_MODE_SPEC> {
        SYSTOP_POWER_MODE_W::new(self, 0)
    }
    #[doc = "Bit 1 - CPU turn-on power mode."]
    #[inline(always)]
    #[must_use]
    pub fn cpu_power_mode(&mut self) -> CPU_POWER_MODE_W<SOFT_TURN_ON_POWER_MODE_SPEC> {
        CPU_POWER_MODE_W::new(self, 1)
    }
    #[doc = "Bit 2 - GPUA turn-on power mode."]
    #[inline(always)]
    #[must_use]
    pub fn gpua_power_mode(&mut self) -> GPUA_POWER_MODE_W<SOFT_TURN_ON_POWER_MODE_SPEC> {
        GPUA_POWER_MODE_W::new(self, 2)
    }
    #[doc = "Bit 3 - VDEC turn-on power mode."]
    #[inline(always)]
    #[must_use]
    pub fn vdec_power_mode(&mut self) -> VDEC_POWER_MODE_W<SOFT_TURN_ON_POWER_MODE_SPEC> {
        VDEC_POWER_MODE_W::new(self, 3)
    }
    #[doc = "Bit 4 - VOUT turn-on power mode."]
    #[inline(always)]
    #[must_use]
    pub fn vout_power_mode(&mut self) -> VOUT_POWER_MODE_W<SOFT_TURN_ON_POWER_MODE_SPEC> {
        VOUT_POWER_MODE_W::new(self, 4)
    }
    #[doc = "Bit 5 - ISP turn-on power mode."]
    #[inline(always)]
    #[must_use]
    pub fn isp_power_mode(&mut self) -> ISP_POWER_MODE_W<SOFT_TURN_ON_POWER_MODE_SPEC> {
        ISP_POWER_MODE_W::new(self, 5)
    }
    #[doc = "Bit 6 - VENC turn-on power mode."]
    #[inline(always)]
    #[must_use]
    pub fn venc_power_mode(&mut self) -> VENC_POWER_MODE_W<SOFT_TURN_ON_POWER_MODE_SPEC> {
...
impl crate::Resettable for SOFT_TURN_ON_POWER_MODE_SPEC {
