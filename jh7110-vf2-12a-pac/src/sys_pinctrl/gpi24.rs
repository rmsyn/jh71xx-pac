...
pub type U0_SAIF_AUDIO_SDIN_MUX_I2SRX_EXT_SDIN1_CFG_W<'a, REG, const O: u8> =
...
pub type U0_SAIF_AUDIO_SDIN_MUX_I2SRX_EXT_SDIN2_CFG_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 7, O>;
...
pub type U0_SSP_SPI_SSPCLKIN_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U0_SSP_SPI_SSPFSSIN_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
...
impl W {
    ...
    pub fn u0_saif_audio_sdin_mux_i2srx_ext_sdin1_cfg(
        &mut self,
    ) -> U0_SAIF_AUDIO_SDIN_MUX_I2SRX_EXT_SDIN1_CFG_W<GPI24_SPEC, 0> {
        U0_SAIF_AUDIO_SDIN_MUX_I2SRX_EXT_SDIN1_CFG_W::new(self)
    }
    #[doc = "Bits 8:14 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u0_saif_audio_sdin_mux_i2srx_ext_sdin2_cfg(
        &mut self,
    ) -> U0_SAIF_AUDIO_SDIN_MUX_I2SRX_EXT_SDIN2_CFG_W<GPI24_SPEC, 8> {
        U0_SAIF_AUDIO_SDIN_MUX_I2SRX_EXT_SDIN2_CFG_W::new(self)
    }
    #[doc = "Bits 16:22 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u0_ssp_spi_sspclkin_cfg(&mut self) -> U0_SSP_SPI_SSPCLKIN_CFG_W<GPI24_SPEC, 16> {
        U0_SSP_SPI_SSPCLKIN_CFG_W::new(self)
    }
    #[doc = "Bits 24:30 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u0_ssp_spi_sspfssin_cfg(&mut self) -> U0_SSP_SPI_SSPFSSIN_CFG_W<GPI24_SPEC, 24> {
        U0_SSP_SPI_SSPFSSIN_CFG_W::new(self)
    }
