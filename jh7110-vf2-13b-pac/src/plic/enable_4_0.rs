#[doc = "Register `enable_4_0` reader"]
...
#[doc = "`read()` method returns [`enable_4_0::R`](R) reader structure"]
impl crate::Readable for ENABLE_4_0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`enable_4_0::W`](W) writer structure"]
