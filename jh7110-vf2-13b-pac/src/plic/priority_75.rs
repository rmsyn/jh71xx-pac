#[doc = "Register `priority_75` reader"]
...
#[doc = "`read()` method returns [`priority_75::R`](R) reader structure"]
impl crate::Readable for PRIORITY_75_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_75::W`](W) writer structure"]
