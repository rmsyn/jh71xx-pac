#[doc = "Register `clk_tdm_neg` reader"]
pub type R = crate::R<CLK_TDM_NEG_SPEC>;
#[doc = "Register `clk_tdm_neg` writer"]
pub type W = crate::W<CLK_TDM_NEG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_polarity(&mut self) -> CLK_POLARITY_W<CLK_TDM_NEG_SPEC, 30> {
...
#[doc = "`read()` method returns [`clk_tdm_neg::R`](R) reader structure"]
impl crate::Readable for CLK_TDM_NEG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_tdm_neg::W`](W) writer structure"]
