#[doc = "Register `clk_noc_vdec_axi` reader"]
pub type R = crate::R<CLK_NOC_VDEC_AXI_SPEC>;
#[doc = "Register `clk_noc_vdec_axi` writer"]
pub type W = crate::W<CLK_NOC_VDEC_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_NOC_VDEC_AXI_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_noc_vdec_axi::R`](R) reader structure"]
impl crate::Readable for CLK_NOC_VDEC_AXI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_noc_vdec_axi::W`](W) writer structure"]
