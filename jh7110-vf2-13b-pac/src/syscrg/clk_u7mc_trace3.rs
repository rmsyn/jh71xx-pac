#[doc = "Register `clk_u7mc_trace3` reader"]
pub type R = crate::R<CLK_U7MC_TRACE3_SPEC>;
#[doc = "Register `clk_u7mc_trace3` writer"]
pub type W = crate::W<CLK_U7MC_TRACE3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U7MC_TRACE3_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u7mc_trace3::R`](R) reader structure"]
impl crate::Readable for CLK_U7MC_TRACE3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u7mc_trace3::W`](W) writer structure"]
