#[doc = "Register `priority_79` reader"]
...
#[doc = "`read()` method returns [`priority_79::R`](R) reader structure"]
impl crate::Readable for PRIORITY_79_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_79::W`](W) writer structure"]
