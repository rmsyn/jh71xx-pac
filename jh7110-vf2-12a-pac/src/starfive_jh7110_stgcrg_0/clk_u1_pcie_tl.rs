#[doc = "Register `clk_u1_pcie_tl` reader"]
pub type R = crate::R<CLK_U1_PCIE_TL_SPEC>;
#[doc = "Register `clk_u1_pcie_tl` writer"]
pub type W = crate::W<CLK_U1_PCIE_TL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U1_PCIE_TL_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u1_pcie_tl::R`](R) reader structure"]
impl crate::Readable for CLK_U1_PCIE_TL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u1_pcie_tl::W`](W) writer structure"]
