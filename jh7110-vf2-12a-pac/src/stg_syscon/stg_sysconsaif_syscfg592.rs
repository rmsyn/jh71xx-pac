...
pub type U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_223_192_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_axi4_slv0_aratomop_223_192(
        &mut self,
    ) -> U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_223_192_W<STG_SYSCONSAIF_SYSCFG592_SPEC, 0> {
        U1_PLDA_PCIE_AXI4_SLV0_ARATOMOP_223_192_W::new(self)
    }
