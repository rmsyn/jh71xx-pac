...
pub type PADCFG_PAD_RGPIO0_IE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PADCFG_PAD_RGPIO0_DS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type PADCFG_PAD_RGPIO0_PU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PADCFG_PAD_RGPIO0_PD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PADCFG_PAD_RGPIO0_SLEW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PADCFG_PAD_RGPIO0_SMT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PADCFG_PAD_RGPIO0_POS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn padcfg_pad_rgpio0_ie(
        &mut self,
    ) -> PADCFG_PAD_RGPIO0_IE_W<AON_IOMUX_CFGSAIF_SYSCFG52_SPEC, 0> {
        PADCFG_PAD_RGPIO0_IE_W::new(self)
    }
    #[doc = "Bits 1:2 - Output Drive Strength (DS) - 00: The rated drive strength is 2 mA, 01: The rated drive strength is 4 mA, 10: The rated drive strength is 8 mA, 11: The rated drive strength is 12 mA"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio0_ds(
        &mut self,
    ) -> PADCFG_PAD_RGPIO0_DS_W<AON_IOMUX_CFGSAIF_SYSCFG52_SPEC, 1> {
        PADCFG_PAD_RGPIO0_DS_W::new(self)
    }
    #[doc = "Bit 3 - Pull-Up (PU) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio0_pu(
        &mut self,
    ) -> PADCFG_PAD_RGPIO0_PU_W<AON_IOMUX_CFGSAIF_SYSCFG52_SPEC, 3> {
        PADCFG_PAD_RGPIO0_PU_W::new(self)
    }
    #[doc = "Bit 4 - Pull-Down (PD) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio0_pd(
        &mut self,
    ) -> PADCFG_PAD_RGPIO0_PD_W<AON_IOMUX_CFGSAIF_SYSCFG52_SPEC, 4> {
        PADCFG_PAD_RGPIO0_PD_W::new(self)
    }
    #[doc = "Bit 5 - Slew Rate Control - 0: Slow (Half frequency), 1: Fast"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio0_slew(
        &mut self,
    ) -> PADCFG_PAD_RGPIO0_SLEW_W<AON_IOMUX_CFGSAIF_SYSCFG52_SPEC, 5> {
        PADCFG_PAD_RGPIO0_SLEW_W::new(self)
    }
    #[doc = "Bit 6 - Active high Schmitt (SMT) trigger selector - 0: No hysteresis, 1: Schmitt trigger ebabled"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio0_smt(
        &mut self,
    ) -> PADCFG_PAD_RGPIO0_SMT_W<AON_IOMUX_CFGSAIF_SYSCFG52_SPEC, 6> {
        PADCFG_PAD_RGPIO0_SMT_W::new(self)
    }
    #[doc = "Bit 7 - Power-on-Start (POS) enabler - 1: Enable active pull down for loss of core power, 0: Active pull-down capability disabled"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio0_pos(
        &mut self,
    ) -> PADCFG_PAD_RGPIO0_POS_W<AON_IOMUX_CFGSAIF_SYSCFG52_SPEC, 7> {
        PADCFG_PAD_RGPIO0_POS_W::new(self)
    }
