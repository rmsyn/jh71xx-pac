...
impl W {
    ...
    pub fn u0_trace_mtx_scfg_c0_in0_ctl(
        &mut self,
    ) -> U0_TRACE_MTX_SCFG_C0_IN0_CTL_W<SYS_SYSCONSAIF_SYSCFG96_SPEC> {
    ...
    pub fn u0_trace_mtx_scfg_c0_in1_ctl(
        &mut self,
    ) -> U0_TRACE_MTX_SCFG_C0_IN1_CTL_W<SYS_SYSCONSAIF_SYSCFG96_SPEC> {
    ...
    pub fn u0_trace_mtx_scfg_c1_in0_ctl(
        &mut self,
    ) -> U0_TRACE_MTX_SCFG_C1_IN0_CTL_W<SYS_SYSCONSAIF_SYSCFG96_SPEC> {
    ...
    pub fn u0_trace_mtx_scfg_c1_in1_ctl(
        &mut self,
    ) -> U0_TRACE_MTX_SCFG_C1_IN1_CTL_W<SYS_SYSCONSAIF_SYSCFG96_SPEC> {
    ...
    pub fn u0_trace_mtx_scfg_c2_in0_ctl(
        &mut self,
    ) -> U0_TRACE_MTX_SCFG_C2_IN0_CTL_W<SYS_SYSCONSAIF_SYSCFG96_SPEC> {
    ...
    pub fn u0_trace_mtx_scfg_c2_in1_ctl(
        &mut self,
    ) -> U0_TRACE_MTX_SCFG_C2_IN1_CTL_W<SYS_SYSCONSAIF_SYSCFG96_SPEC> {
