...
pub type U0_PLDA_PCIE_K_PHYPARAM_287_256_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_plda_pcie_k_phyparam_287_256(
        &mut self,
    ) -> U0_PLDA_PCIE_K_PHYPARAM_287_256_W<STG_SYSCONSAIF_SYSCFG232_SPEC, 0> {
        U0_PLDA_PCIE_K_PHYPARAM_287_256_W::new(self)
    }
