#[doc = "Register `priority_113` reader"]
...
#[doc = "`read()` method returns [`priority_113::R`](R) reader structure"]
impl crate::Readable for PRIORITY_113_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_113::W`](W) writer structure"]
