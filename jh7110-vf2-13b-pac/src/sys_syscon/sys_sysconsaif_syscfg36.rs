...
pub type U0_PLL_WRAP_PLL0_PREDIV_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type U0_PLL_WRAP_PLL0_TESTEN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type U0_PLL_WRAP_PLL0_TESTSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type U0_PLL_WRAP_PLL1_CPI_BIAS_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type U0_PLL_WRAP_PLL1_CPP_BIAS_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type U0_PLL_WRAP_PLL1_DACPD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type U0_PLL_WRAP_PLL1_DSMPD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type U0_PLL_WRAP_PLL1_FBDIV_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
...
impl W {
    ...
    pub fn u0_pll_wrap_pll0_prediv(
        &mut self,
    ) -> U0_PLL_WRAP_PLL0_PREDIV_W<SYS_SYSCONSAIF_SYSCFG36_SPEC> {
        U0_PLL_WRAP_PLL0_PREDIV_W::new(self, 0)
    }
    #[doc = "Bit 6 - u0_pll_wrap_pll0_testen"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll0_testen(
        &mut self,
    ) -> U0_PLL_WRAP_PLL0_TESTEN_W<SYS_SYSCONSAIF_SYSCFG36_SPEC> {
        U0_PLL_WRAP_PLL0_TESTEN_W::new(self, 6)
    }
    #[doc = "Bits 7:8 - u0_pll_wrap_pll0_testsel"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll0_testsel(
        &mut self,
    ) -> U0_PLL_WRAP_PLL0_TESTSEL_W<SYS_SYSCONSAIF_SYSCFG36_SPEC> {
        U0_PLL_WRAP_PLL0_TESTSEL_W::new(self, 7)
    }
    #[doc = "Bits 9:11 - u0_pll_wrap_pll1_cpi_bias"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_cpi_bias(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_CPI_BIAS_W<SYS_SYSCONSAIF_SYSCFG36_SPEC> {
        U0_PLL_WRAP_PLL1_CPI_BIAS_W::new(self, 9)
    }
    #[doc = "Bits 12:14 - u0_pll_wrap_pll1_cpp_bias"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_cpp_bias(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_CPP_BIAS_W<SYS_SYSCONSAIF_SYSCFG36_SPEC> {
        U0_PLL_WRAP_PLL1_CPP_BIAS_W::new(self, 12)
    }
    #[doc = "Bit 15 - u0_pll_wrap_pll1_dacpd"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_dacpd(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_DACPD_W<SYS_SYSCONSAIF_SYSCFG36_SPEC> {
        U0_PLL_WRAP_PLL1_DACPD_W::new(self, 15)
    }
    #[doc = "Bit 16 - u0_pll_wrap_pll1_dsmpd"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_dsmpd(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_DSMPD_W<SYS_SYSCONSAIF_SYSCFG36_SPEC> {
        U0_PLL_WRAP_PLL1_DSMPD_W::new(self, 16)
    }
    #[doc = "Bits 17:28 - u0_pll_wrap_pll1_fbdiv"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_fbdiv(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_FBDIV_W<SYS_SYSCONSAIF_SYSCFG36_SPEC> {
        U0_PLL_WRAP_PLL1_FBDIV_W::new(self, 17)
    }
