#[doc = "Register `priority_92` reader"]
...
#[doc = "`read()` method returns [`priority_92::R`](R) reader structure"]
impl crate::Readable for PRIORITY_92_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_92::W`](W) writer structure"]
