...
pub type CLR_GEN_CALL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr_gen_call(&mut self) -> CLR_GEN_CALL_W<CLR_GEN_CALL_SPEC, 0> {
        CLR_GEN_CALL_W::new(self)
    }
...
#[doc = "DesignWare I2C Clear General Call\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clr_gen_call::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clr_gen_call::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
