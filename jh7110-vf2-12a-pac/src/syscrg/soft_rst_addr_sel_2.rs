#[doc = "Register `soft_rst_addr_sel_2` reader"]
...
#[doc = "Software RESET 2 Address Selector\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`soft_rst_addr_sel_2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`soft_rst_addr_sel_2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SOFT_RST_ADDR_SEL_2_SPEC;
impl crate::RegisterSpec for SOFT_RST_ADDR_SEL_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`soft_rst_addr_sel_2::R`](R) reader structure"]
impl crate::Readable for SOFT_RST_ADDR_SEL_2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`soft_rst_addr_sel_2::W`](W) writer structure"]
impl crate::Writable for SOFT_RST_ADDR_SEL_2_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets soft_rst_addr_sel_2 to value 0"]
impl crate::Resettable for SOFT_RST_ADDR_SEL_2_SPEC {
