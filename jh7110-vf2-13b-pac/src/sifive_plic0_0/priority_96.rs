#[doc = "Register `priority_96` reader"]
...
#[doc = "`read()` method returns [`priority_96::R`](R) reader structure"]
impl crate::Readable for PRIORITY_96_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_96::W`](W) writer structure"]
