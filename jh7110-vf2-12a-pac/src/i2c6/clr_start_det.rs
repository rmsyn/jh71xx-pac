...
pub type CLR_START_DET_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr_start_det(&mut self) -> CLR_START_DET_W<CLR_START_DET_SPEC> {
        CLR_START_DET_W::new(self, 0)
    }
