#[doc = "Register `aon_iomux_cfgsaif_syscfg136` reader"]
pub type R = crate::R<AON_IOMUX_CFGSAIF_SYSCFG136_SPEC>;
#[doc = "Register `aon_iomux_cfgsaif_syscfg136` writer"]
pub type W = crate::W<AON_IOMUX_CFGSAIF_SYSCFG136_SPEC>;
...
impl R {
    ...
    #[inline(always)]
    pub fn padcfg_pad_gmac0_txen_syscon(&self) -> PADCFG_PAD_GMAC0_TXEN_SYSCON_R {
        PADCFG_PAD_GMAC0_TXEN_SYSCON_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - padcfg_pad_gmac0_txen_syscon"]
...
pub struct AON_IOMUX_CFGSAIF_SYSCFG136_SPEC;
impl crate::RegisterSpec for AON_IOMUX_CFGSAIF_SYSCFG136_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aon_iomux_cfgsaif_syscfg136::R`](R) reader structure"]
impl crate::Readable for AON_IOMUX_CFGSAIF_SYSCFG136_SPEC {}
#[doc = "`write(|w| ..)` method takes [`aon_iomux_cfgsaif_syscfg136::W`](W) writer structure"]
impl crate::Writable for AON_IOMUX_CFGSAIF_SYSCFG136_SPEC {
