...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode_err(&mut self) -> MODE_ERR_W<IRQ_MASK_SPEC> {
        MODE_ERR_W::new(self, 0)
    }
    #[doc = "Bit 1 - Buffer underflow interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn underflow(&mut self) -> UNDERFLOW_W<IRQ_MASK_SPEC> {
        UNDERFLOW_W::new(self, 1)
    }
    #[doc = "Bit 2 - Indirect computation interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ind_comp(&mut self) -> IND_COMP_W<IRQ_MASK_SPEC> {
        IND_COMP_W::new(self, 2)
    }
    #[doc = "Bit 3 - Indirect read rejection interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ind_rd_reject(&mut self) -> IND_RD_REJECT_W<IRQ_MASK_SPEC> {
        IND_RD_REJECT_W::new(self, 3)
    }
    #[doc = "Bit 4 - Write protected error interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn wr_protected_err(&mut self) -> WR_PROTECTED_ERR_W<IRQ_MASK_SPEC> {
        WR_PROTECTED_ERR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Illegal AHB clock error interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn illegal_ahb_err(&mut self) -> ILLEGAL_AHB_ERR_W<IRQ_MASK_SPEC> {
        ILLEGAL_AHB_ERR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Watermark interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn watermark(&mut self) -> WATERMARK_W<IRQ_MASK_SPEC> {
        WATERMARK_W::new(self, 6)
    }
    #[doc = "Bit 12 - Indirect SRAM full interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ind_sram_full(&mut self) -> IND_SRAM_FULL_W<IRQ_MASK_SPEC> {
