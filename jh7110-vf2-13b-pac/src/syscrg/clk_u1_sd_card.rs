#[doc = "Register `clk_u1_sd_card` reader"]
pub type R = crate::R<CLK_U1_SD_CARD_SPEC>;
#[doc = "Register `clk_u1_sd_card` writer"]
pub type W = crate::W<CLK_U1_SD_CARD_SPEC>;
...
#[doc = "`read()` method returns [`clk_u1_sd_card::R`](R) reader structure"]
impl crate::Readable for CLK_U1_SD_CARD_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u1_sd_card::W`](W) writer structure"]
