#[doc = "Register `sys_sysconsaif_syscfg16` reader"]
pub type R = crate::R<SYS_SYSCONSAIF_SYSCFG16_SPEC>;
#[doc = "Register `sys_sysconsaif_syscfg16` writer"]
pub type W = crate::W<SYS_SYSCONSAIF_SYSCFG16_SPEC>;
...
#[doc = "SYS SYSCONSAIF SYSCFG 16\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sys_sysconsaif_syscfg16::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sys_sysconsaif_syscfg16::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SYS_SYSCONSAIF_SYSCFG16_SPEC;
impl crate::RegisterSpec for SYS_SYSCONSAIF_SYSCFG16_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sys_sysconsaif_syscfg16::R`](R) reader structure"]
impl crate::Readable for SYS_SYSCONSAIF_SYSCFG16_SPEC {}
#[doc = "`write(|w| ..)` method takes [`sys_sysconsaif_syscfg16::W`](W) writer structure"]
impl crate::Writable for SYS_SYSCONSAIF_SYSCFG16_SPEC {
