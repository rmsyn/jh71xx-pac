...
pub type R = crate::R<CLK_DMA_AXI_SPEC>;
#[doc = "Register `clk_dma_axi` writer"]
pub type W = crate::W<CLK_DMA_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_DMA_AXI_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_DMA_AXI_SPEC {}
