#[doc = "Register `clk_i2s_lrck_mst` reader"]
pub type R = crate::R<CLK_I2S_LRCK_MST_SPEC>;
#[doc = "Register `clk_i2s_lrck_mst` writer"]
pub type W = crate::W<CLK_I2S_LRCK_MST_SPEC>;
...
#[doc = "Field `clk_mux_sel` reader - Clock multiplexing selector: clk_i2srx_3ch_bclk_mst_inv, clk_i2srx_3ch_bclk_mst"]
pub type CLK_MUX_SEL_R = crate::FieldReader;
#[doc = "Field `clk_mux_sel` writer - Clock multiplexing selector: clk_i2srx_3ch_bclk_mst_inv, clk_i2srx_3ch_bclk_mst"]
...
impl R {
    ...
    #[doc = "Bits 24:29 - Clock multiplexing selector: clk_i2srx_3ch_bclk_mst_inv, clk_i2srx_3ch_bclk_mst"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_I2S_LRCK_MST_SPEC, 0> {
        CLK_DIVCFG_W::new(self)
    }
    #[doc = "Bits 24:29 - Clock multiplexing selector: clk_i2srx_3ch_bclk_mst_inv, clk_i2srx_3ch_bclk_mst"]
    #[inline(always)]
    #[must_use]
    pub fn clk_mux_sel(&mut self) -> CLK_MUX_SEL_W<CLK_I2S_LRCK_MST_SPEC, 24> {
...
#[doc = "`read()` method returns [`clk_i2s_lrck_mst::R`](R) reader structure"]
impl crate::Readable for CLK_I2S_LRCK_MST_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_i2s_lrck_mst::W`](W) writer structure"]
