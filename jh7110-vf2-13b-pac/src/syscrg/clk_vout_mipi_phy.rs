#[doc = "Register `clk_vout_mipi_phy` reader"]
pub type R = crate::R<CLK_VOUT_MIPI_PHY_SPEC>;
#[doc = "Register `clk_vout_mipi_phy` writer"]
pub type W = crate::W<CLK_VOUT_MIPI_PHY_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_VOUT_MIPI_PHY_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_vout_mipi_phy::R`](R) reader structure"]
impl crate::Readable for CLK_VOUT_MIPI_PHY_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_vout_mipi_phy::W`](W) writer structure"]
