...
pub type U6_SSP_SPI_SSPCLKIN_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
pub type U6_SSP_SPI_SSPFSSIN_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
pub type U6_SSP_SPI_SSPRXD_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn u6_ssp_spi_sspclkin_cfg(&mut self) -> U6_SSP_SPI_SSPCLKIN_CFG_W<GPI88_SPEC> {
        U6_SSP_SPI_SSPCLKIN_CFG_W::new(self, 0)
    }
    #[doc = "Bits 8:14 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u6_ssp_spi_sspfssin_cfg(&mut self) -> U6_SSP_SPI_SSPFSSIN_CFG_W<GPI88_SPEC> {
        U6_SSP_SPI_SSPFSSIN_CFG_W::new(self, 8)
    }
    #[doc = "Bits 16:22 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u6_ssp_spi_ssprxd_cfg(&mut self) -> U6_SSP_SPI_SSPRXD_CFG_W<GPI88_SPEC> {
        U6_SSP_SPI_SSPRXD_CFG_W::new(self, 16)
    }
