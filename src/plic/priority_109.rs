#[doc = "Register `priority_109` reader"]
...
#[doc = "`read()` method returns [`priority_109::R`](R) reader structure"]
impl crate::Readable for PRIORITY_109_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_109::W`](W) writer structure"]
