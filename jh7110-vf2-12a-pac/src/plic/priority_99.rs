#[doc = "Register `priority_99` reader"]
...
#[doc = "`read()` method returns [`priority_99::R`](R) reader structure"]
impl crate::Readable for PRIORITY_99_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_99::W`](W) writer structure"]
