#[doc = "Register `priority_120` reader"]
...
#[doc = "`read()` method returns [`priority_120::R`](R) reader structure"]
impl crate::Readable for PRIORITY_120_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_120::W`](W) writer structure"]
