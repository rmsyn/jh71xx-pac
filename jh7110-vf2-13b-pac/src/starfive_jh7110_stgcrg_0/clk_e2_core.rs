...
pub type R = crate::R<CLK_E2_CORE_SPEC>;
#[doc = "Register `clk_e2_core` writer"]
pub type W = crate::W<CLK_E2_CORE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_E2_CORE_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_E2_CORE_SPEC {}
