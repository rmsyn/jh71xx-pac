...
pub type U1_PLDA_PCIE_PL_SIDEBAND_IN_63_32_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_pl_sideband_in_63_32(
        &mut self,
    ) -> U1_PLDA_PCIE_PL_SIDEBAND_IN_63_32_W<STG_SYSCONSAIF_SYSCFG772_SPEC, 0> {
        U1_PLDA_PCIE_PL_SIDEBAND_IN_63_32_W::new(self)
    }
