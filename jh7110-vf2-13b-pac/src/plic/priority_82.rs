#[doc = "Register `priority_82` reader"]
...
#[doc = "`read()` method returns [`priority_82::R`](R) reader structure"]
impl crate::Readable for PRIORITY_82_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_82::W`](W) writer structure"]
