#[doc = "Register `enable_3_4` reader"]
...
#[doc = "`read()` method returns [`enable_3_4::R`](R) reader structure"]
impl crate::Readable for ENABLE_3_4_SPEC {}
#[doc = "`write(|w| ..)` method takes [`enable_3_4::W`](W) writer structure"]
