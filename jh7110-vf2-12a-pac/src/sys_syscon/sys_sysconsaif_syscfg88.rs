...
pub type U0_SFT7110_NOC_BUS_OIC_QCH_CLOCK_STOP_THRESHOLD_7_W<'a, REG> =
...
impl W {
    ...
    pub fn u0_sft7110_noc_bus_oic_qch_clock_stop_threshold_7(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_OIC_QCH_CLOCK_STOP_THRESHOLD_7_W<SYS_SYSCONSAIF_SYSCFG88_SPEC> {
        U0_SFT7110_NOC_BUS_OIC_QCH_CLOCK_STOP_THRESHOLD_7_W::new(self, 0)
    }
