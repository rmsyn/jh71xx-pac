#[doc = "Register `soft_rst3_addr_sel` reader"]
pub type R = crate::R<SOFT_RST3_ADDR_SEL_SPEC>;
#[doc = "Register `soft_rst3_addr_sel` writer"]
pub type W = crate::W<SOFT_RST3_ADDR_SEL_SPEC>;
...
impl W {
    ...
    pub fn rstn_u0_pwmdac_rstn_apb(
        &mut self,
    ) -> RSTN_U0_PWMDAC_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 0> {
    ...
    pub fn rstn_u0_pdm_4mic_rstn_dmic(
        &mut self,
    ) -> RSTN_U0_PDM_4MIC_RSTN_DMIC_W<SOFT_RST3_ADDR_SEL_SPEC, 1> {
    ...
    pub fn rstn_u0_pdm_4mic_rstn_apb(
        &mut self,
    ) -> RSTN_U0_PDM_4MIC_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 2> {
    ...
    pub fn rstn_u0_i2srx_3ch_rstn_apb(
        &mut self,
    ) -> RSTN_U0_I2SRX_3CH_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 3> {
    ...
    pub fn rstn_u0_i2srx_3ch_rstn_bclk(
        &mut self,
    ) -> RSTN_U0_I2SRX_3CH_RSTN_BCLK_W<SOFT_RST3_ADDR_SEL_SPEC, 4> {
    ...
    pub fn rstn_u0_i2stx_4ch_rstn_apb(
        &mut self,
    ) -> RSTN_U0_I2STX_4CH_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 5> {
    ...
    pub fn rstn_u0_i2stx_4ch_rstn_bclk(
        &mut self,
    ) -> RSTN_U0_I2STX_4CH_RSTN_BCLK_W<SOFT_RST3_ADDR_SEL_SPEC, 6> {
    ...
    pub fn rstn_u1_i2stx_4ch_rstn_apb(
        &mut self,
    ) -> RSTN_U1_I2STX_4CH_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 7> {
    ...
    pub fn rstn_u1_i2stx_4ch_rstn_bclk(
        &mut self,
    ) -> RSTN_U1_I2STX_4CH_RSTN_BCLK_W<SOFT_RST3_ADDR_SEL_SPEC, 8> {
    ...
    pub fn rstn_u0_tdm16slot_rstn_ahb(
        &mut self,
    ) -> RSTN_U0_TDM16SLOT_RSTN_AHB_W<SOFT_RST3_ADDR_SEL_SPEC, 9> {
    ...
    pub fn rstn_u0_tdm16slot_rstn_tdm(
        &mut self,
    ) -> RSTN_U0_TDM16SLOT_RSTN_TDM_W<SOFT_RST3_ADDR_SEL_SPEC, 10> {
    ...
    pub fn rstn_u0_tdm16slot_rstn_apb(
        &mut self,
    ) -> RSTN_U0_TDM16SLOT_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 11> {
    ...
    pub fn rstn_u0_pwm_8ch_rstn_apb(
        &mut self,
    ) -> RSTN_U0_PWM_8CH_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 12> {
    ...
    pub fn rstn_u0_dskit_wdt_rstn_apb(
        &mut self,
    ) -> RSTN_U0_DSKIT_WDT_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 13> {
    ...
    pub fn rstn_u0_dskit_wdt_rstn_wdt(
        &mut self,
    ) -> RSTN_U0_DSKIT_WDT_RSTN_WDT_W<SOFT_RST3_ADDR_SEL_SPEC, 14> {
    ...
    pub fn rstn_u0_can_ctrl_rstn_apb(
        &mut self,
    ) -> RSTN_U0_CAN_CTRL_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 15> {
    ...
    pub fn rstn_u0_can_ctrl_rstn_can(
        &mut self,
    ) -> RSTN_U0_CAN_CTRL_RSTN_CAN_W<SOFT_RST3_ADDR_SEL_SPEC, 16> {
    ...
    pub fn rstn_u0_can_ctrl_rstn_timer(
        &mut self,
    ) -> RSTN_U0_CAN_CTRL_RSTN_TIMER_W<SOFT_RST3_ADDR_SEL_SPEC, 17> {
    ...
    pub fn rstn_u1_can_ctrl_rstn_apb(
        &mut self,
    ) -> RSTN_U1_CAN_CTRL_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 18> {
    ...
    pub fn rstn_u1_can_ctrl_rstn_can(
        &mut self,
    ) -> RSTN_U1_CAN_CTRL_RSTN_CAN_W<SOFT_RST3_ADDR_SEL_SPEC, 19> {
    ...
    pub fn rstn_u1_can_ctrl_rstn_timer(
        &mut self,
    ) -> RSTN_U1_CAN_CTRL_RSTN_TIMER_W<SOFT_RST3_ADDR_SEL_SPEC, 20> {
    ...
    pub fn rstn_u0_si5_timer_rstn_apb(
        &mut self,
    ) -> RSTN_U0_SI5_TIMER_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 21> {
    ...
    pub fn rstn_u0_si5_timer_rstn_timer0(
        &mut self,
    ) -> RSTN_U0_SI5_TIMER_RSTN_TIMER0_W<SOFT_RST3_ADDR_SEL_SPEC, 22> {
    ...
    pub fn rstn_u0_si5_timer_rstn_time10(
        &mut self,
    ) -> RSTN_U0_SI5_TIMER_RSTN_TIME10_W<SOFT_RST3_ADDR_SEL_SPEC, 23> {
    ...
    pub fn rstn_u0_si5_timer_rstn_timer2(
        &mut self,
    ) -> RSTN_U0_SI5_TIMER_RSTN_TIMER2_W<SOFT_RST3_ADDR_SEL_SPEC, 24> {
    ...
    pub fn rstn_u0_si5_timer_rstn_timer3(
        &mut self,
    ) -> RSTN_U0_SI5_TIMER_RSTN_TIMER3_W<SOFT_RST3_ADDR_SEL_SPEC, 25> {
    ...
    pub fn rstn_u0_int_ctrl_rstn_apb(
        &mut self,
    ) -> RSTN_U0_INT_CTRL_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 26> {
    ...
    pub fn rstn_u0_temp_sensor_rstn_apb(
        &mut self,
    ) -> RSTN_U0_TEMP_SENSOR_RSTN_APB_W<SOFT_RST3_ADDR_SEL_SPEC, 27> {
    ...
    pub fn rstn_u0_temp_sensor_rstn_temp(
        &mut self,
    ) -> RSTN_U0_TEMP_SENSOR_RSTN_TEMP_W<SOFT_RST3_ADDR_SEL_SPEC, 28> {
    ...
    pub fn rstn_u0_jtag_certification_rst_n(
        &mut self,
    ) -> RSTN_U0_JTAG_CERTIFICATION_RST_N_W<SOFT_RST3_ADDR_SEL_SPEC, 29> {
...
#[doc = "`read()` method returns [`soft_rst3_addr_sel::R`](R) reader structure"]
impl crate::Readable for SOFT_RST3_ADDR_SEL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`soft_rst3_addr_sel::W`](W) writer structure"]
