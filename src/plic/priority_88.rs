#[doc = "Register `priority_88` reader"]
...
#[doc = "`read()` method returns [`priority_88::R`](R) reader structure"]
impl crate::Readable for PRIORITY_88_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_88::W`](W) writer structure"]
