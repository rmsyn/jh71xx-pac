#[doc = "Register `clk_gmac1_gtx` reader"]
pub type R = crate::R<CLK_GMAC1_GTX_SPEC>;
#[doc = "Register `clk_gmac1_gtx` writer"]
pub type W = crate::W<CLK_GMAC1_GTX_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_GMAC1_GTX_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_gmac1_gtx::R`](R) reader structure"]
impl crate::Readable for CLK_GMAC1_GTX_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_gmac1_gtx::W`](W) writer structure"]
