#[doc = "Register `clk_pcie01_slv_dec_main` reader"]
pub type R = crate::R<CLK_PCIE01_SLV_DEC_MAIN_SPEC>;
#[doc = "Register `clk_pcie01_slv_dec_main` writer"]
pub type W = crate::W<CLK_PCIE01_SLV_DEC_MAIN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_PCIE01_SLV_DEC_MAIN_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_pcie01_slv_dec_main::R`](R) reader structure"]
impl crate::Readable for CLK_PCIE01_SLV_DEC_MAIN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_pcie01_slv_dec_main::W`](W) writer structure"]
