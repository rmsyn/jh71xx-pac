#[doc = "Register `priority_116` reader"]
...
#[doc = "`read()` method returns [`priority_116::R`](R) reader structure"]
impl crate::Readable for PRIORITY_116_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_116::W`](W) writer structure"]
