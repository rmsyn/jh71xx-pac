...
pub type R = crate::R<CLK_HIFI4_CORE_SPEC>;
#[doc = "Register `clk_hifi4_core` writer"]
pub type W = crate::W<CLK_HIFI4_CORE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_HIFI4_CORE_SPEC, 0> {
...
impl crate::Readable for CLK_HIFI4_CORE_SPEC {}
