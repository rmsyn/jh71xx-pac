...
pub type R = crate::R<CLK_STG_MTRX_GROUP1_HIFI_SPEC>;
#[doc = "Register `clk_stg_mtrx_group1_hifi` writer"]
pub type W = crate::W<CLK_STG_MTRX_GROUP1_HIFI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_STG_MTRX_GROUP1_HIFI_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_STG_MTRX_GROUP1_HIFI_SPEC {}
