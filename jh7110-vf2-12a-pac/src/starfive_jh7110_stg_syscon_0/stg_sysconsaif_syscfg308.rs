...
pub type U0_PLDA_PCIE_LOCAL_INTERRUPT_IN_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_plda_pcie_local_interrupt_in(
        &mut self,
    ) -> U0_PLDA_PCIE_LOCAL_INTERRUPT_IN_W<STG_SYSCONSAIF_SYSCFG308_SPEC, 0> {
        U0_PLDA_PCIE_LOCAL_INTERRUPT_IN_W::new(self)
    }
