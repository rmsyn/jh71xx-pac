#[doc = "Register `priority_102` reader"]
...
#[doc = "`read()` method returns [`priority_102::R`](R) reader structure"]
impl crate::Readable for PRIORITY_102_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_102::W`](W) writer structure"]
