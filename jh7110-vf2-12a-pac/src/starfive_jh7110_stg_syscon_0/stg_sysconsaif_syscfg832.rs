...
pub type U1_PLDA_PCIE_TEST_OUT_BRIDGE_319_288_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_test_out_bridge_319_288(
        &mut self,
    ) -> U1_PLDA_PCIE_TEST_OUT_BRIDGE_319_288_W<STG_SYSCONSAIF_SYSCFG832_SPEC, 0> {
        U1_PLDA_PCIE_TEST_OUT_BRIDGE_319_288_W::new(self)
    }
