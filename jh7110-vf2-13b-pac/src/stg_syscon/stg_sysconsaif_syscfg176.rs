...
impl W {
    ...
    pub fn u0_plda_pcie_axi4_slv0_aruser_40_32(
        &mut self,
    ) -> U0_PLDA_PCIE_AXI4_SLV0_ARUSER_40_32_W<STG_SYSCONSAIF_SYSCFG176_SPEC> {
    ...
    pub fn u0_plda_pcie_axi4_slv0_awfunc(
        &mut self,
    ) -> U0_PLDA_PCIE_AXI4_SLV0_AWFUNC_W<STG_SYSCONSAIF_SYSCFG176_SPEC> {
    ...
    pub fn u0_plda_pcie_axi4_slv0_awregion(
        &mut self,
    ) -> U0_PLDA_PCIE_AXI4_SLV0_AWREGION_W<STG_SYSCONSAIF_SYSCFG176_SPEC> {
