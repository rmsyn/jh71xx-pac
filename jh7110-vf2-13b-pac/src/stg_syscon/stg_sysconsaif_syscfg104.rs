#[doc = "Register `stg_sysconsaif_syscfg104` reader"]
pub type R = crate::R<STG_SYSCONSAIF_SYSCFG104_SPEC>;
#[doc = "Register `stg_sysconsaif_syscfg104` writer"]
pub type W = crate::W<STG_SYSCONSAIF_SYSCFG104_SPEC>;
...
#[doc = "STG SYSCONSAIF SYSCFG 104\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`stg_sysconsaif_syscfg104::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`stg_sysconsaif_syscfg104::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct STG_SYSCONSAIF_SYSCFG104_SPEC;
impl crate::RegisterSpec for STG_SYSCONSAIF_SYSCFG104_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_sysconsaif_syscfg104::R`](R) reader structure"]
impl crate::Readable for STG_SYSCONSAIF_SYSCFG104_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_sysconsaif_syscfg104::W`](W) writer structure"]
impl crate::Writable for STG_SYSCONSAIF_SYSCFG104_SPEC {
