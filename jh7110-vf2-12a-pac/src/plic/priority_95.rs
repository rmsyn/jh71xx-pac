#[doc = "Register `priority_95` reader"]
...
#[doc = "`read()` method returns [`priority_95::R`](R) reader structure"]
impl crate::Readable for PRIORITY_95_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_95::W`](W) writer structure"]
