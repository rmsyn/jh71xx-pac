#[doc = "Register `clk_u0_uart_core` reader"]
pub type R = crate::R<CLK_U0_UART_CORE_SPEC>;
#[doc = "Register `clk_u0_uart_core` writer"]
pub type W = crate::W<CLK_U0_UART_CORE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U0_UART_CORE_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u0_uart_core::R`](R) reader structure"]
impl crate::Readable for CLK_U0_UART_CORE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_uart_core::W`](W) writer structure"]
