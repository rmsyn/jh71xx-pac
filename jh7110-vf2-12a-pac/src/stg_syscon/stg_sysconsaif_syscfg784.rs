...
pub type U1_PLDA_PCIE_PL_WAKE_IN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    pub fn u1_plda_pcie_pl_wake_in(
        &mut self,
    ) -> U1_PLDA_PCIE_PL_WAKE_IN_W<STG_SYSCONSAIF_SYSCFG784_SPEC, 0> {
        U1_PLDA_PCIE_PL_WAKE_IN_W::new(self)
    }
