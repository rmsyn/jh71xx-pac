#[doc = "Register `priority_78` reader"]
...
#[doc = "`read()` method returns [`priority_78::R`](R) reader structure"]
impl crate::Readable for PRIORITY_78_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_78::W`](W) writer structure"]
