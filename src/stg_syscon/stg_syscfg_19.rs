...
#[doc = "STG SYSCONSAIF SYSCFG 76\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`stg_syscfg_19::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`stg_syscfg_19::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct STG_SYSCFG_19_SPEC;
impl crate::RegisterSpec for STG_SYSCFG_19_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_syscfg_19::R`](R) reader structure"]
impl crate::Readable for STG_SYSCFG_19_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_syscfg_19::W`](W) writer structure"]
impl crate::Writable for STG_SYSCFG_19_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets stg_syscfg_19 to value 0"]
impl crate::Resettable for STG_SYSCFG_19_SPEC {
