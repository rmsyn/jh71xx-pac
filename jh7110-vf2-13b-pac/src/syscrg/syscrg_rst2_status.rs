...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rstn_u0_sdio_rstn_ahb(&mut self) -> RSTN_U0_SDIO_RSTN_AHB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U0_SDIO_RSTN_AHB_W::new(self, 0)
    }
    #[doc = "Bit 1 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u1_sdi_rstn_ahb(&mut self) -> RSTN_U1_SDI_RSTN_AHB_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u1_gmac5_axi64_aresetn_i(
        &mut self,
    ) -> RSTN_U1_GMAC5_AXI64_ARESETN_I_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u1_gmac5_axi64_hresetn_n(
        &mut self,
    ) -> RSTN_U1_GMAC5_AXI64_HRESETN_N_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u0_mailbox_presetn(
        &mut self,
    ) -> RSTN_U0_MAILBOX_PRESETN_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u0_ssp_spi_rstn_apb(
        &mut self,
    ) -> RSTN_U0_SSP_SPI_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u1_ssp_spi_rstn_apb(
        &mut self,
    ) -> RSTN_U1_SSP_SPI_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u2_ssp_spi_rstn_apb(
        &mut self,
    ) -> RSTN_U2_SSP_SPI_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u3_ssp_spi_rstn_apb(
        &mut self,
    ) -> RSTN_U3_SSP_SPI_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u4_ssp_spi_rstn_apb(
        &mut self,
    ) -> RSTN_U4_SSP_SPI_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u5_ssp_spi_rstn_apb(
        &mut self,
    ) -> RSTN_U5_SSP_SPI_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u6_ssp_spi_rstn_apb(
        &mut self,
    ) -> RSTN_U6_SSP_SPI_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U6_SSP_SPI_RSTN_APB_W::new(self, 11)
    }
    #[doc = "Bit 12 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u0_i2c_rstn_apb(&mut self) -> RSTN_U0_I2C_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U0_I2C_RSTN_APB_W::new(self, 12)
    }
    #[doc = "Bit 13 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u1_i2c_rstn_apb(&mut self) -> RSTN_U1_I2C_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U1_I2C_RSTN_APB_W::new(self, 13)
    }
    #[doc = "Bit 14 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u2_i2c_rstn_apb(&mut self) -> RSTN_U2_I2C_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U2_I2C_RSTN_APB_W::new(self, 14)
    }
    #[doc = "Bit 15 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u3_i2c_rstn_apb(&mut self) -> RSTN_U3_I2C_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U3_I2C_RSTN_APB_W::new(self, 15)
    }
    #[doc = "Bit 16 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u4_i2c_rstn_apb(&mut self) -> RSTN_U4_I2C_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U4_I2C_RSTN_APB_W::new(self, 16)
    }
    #[doc = "Bit 17 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u5_i2c_rstn_apb(&mut self) -> RSTN_U5_I2C_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U5_I2C_RSTN_APB_W::new(self, 17)
    }
    #[doc = "Bit 18 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u6_i2c_rstn_apb(&mut self) -> RSTN_U6_I2C_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U6_I2C_RSTN_APB_W::new(self, 18)
    }
    #[doc = "Bit 19 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u0_uart_rstn_apb(&mut self) -> RSTN_U0_UART_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U0_UART_RSTN_APB_W::new(self, 19)
    }
    #[doc = "Bit 20 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u0_uart_rstn_core(&mut self) -> RSTN_U0_UART_RSTN_CORE_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U0_UART_RSTN_CORE_W::new(self, 20)
    }
    #[doc = "Bit 21 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u1_uart_rstn_apb(&mut self) -> RSTN_U1_UART_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U1_UART_RSTN_APB_W::new(self, 21)
    }
    #[doc = "Bit 22 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u1_uart_rstn_core(&mut self) -> RSTN_U1_UART_RSTN_CORE_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U1_UART_RSTN_CORE_W::new(self, 22)
    }
    #[doc = "Bit 23 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u2_uart_rstn_apb(&mut self) -> RSTN_U2_UART_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U2_UART_RSTN_APB_W::new(self, 23)
    }
    #[doc = "Bit 24 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u2_uart_rstn_core(&mut self) -> RSTN_U2_UART_RSTN_CORE_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U2_UART_RSTN_CORE_W::new(self, 24)
    }
    #[doc = "Bit 25 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u3_uart_rstn_apb(&mut self) -> RSTN_U3_UART_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U3_UART_RSTN_APB_W::new(self, 25)
    }
    #[doc = "Bit 26 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u3_uart_rstn_core(&mut self) -> RSTN_U3_UART_RSTN_CORE_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U3_UART_RSTN_CORE_W::new(self, 26)
    }
    #[doc = "Bit 27 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u4_uart_rstn_apb(&mut self) -> RSTN_U4_UART_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U4_UART_RSTN_APB_W::new(self, 27)
    }
    #[doc = "Bit 28 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u4_uart_rstn_core(&mut self) -> RSTN_U4_UART_RSTN_CORE_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U4_UART_RSTN_CORE_W::new(self, 28)
    }
    #[doc = "Bit 29 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u5_uart_rstn_apb(&mut self) -> RSTN_U5_UART_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
        RSTN_U5_UART_RSTN_APB_W::new(self, 29)
    }
    #[doc = "Bit 30 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn_u6_uart_rstn_core(&mut self) -> RSTN_U6_UART_RSTN_CORE_W<SYSCRG_RST2_STATUS_SPEC> {
    ...
    pub fn rstn_u0_cdns_spdif_rstn_apb(
        &mut self,
    ) -> RSTN_U0_CDNS_SPDIF_RSTN_APB_W<SYSCRG_RST2_STATUS_SPEC> {
