...
pub type U0_PLL_WRAP_PLL2_PREDIV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
pub type U0_PLL_WRAP_PLL2_TESTEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLL_WRAP_PLL2_TESTSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_PLL_WRAP_SYSCFG_TEST_PLL_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_SAIF_AUDIO_SDIN_MUX_SCFG_I2SDIN_SEL_W<'a, REG, const O: u8> =
...
pub type U0_SFT7110_NOC_BUS_CLOCK_GATING_OFF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_SFT7110_NOC_BUS_OIC_EVEMON_0_START_W<'a, REG, const O: u8> =
...
pub type U0_SFT7110_NOC_BUS_OIC_EVEMON_1_START_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
...
pub type U0_SFT7110_NOC_BUS_OIC_EVEMON_2_START_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
...
pub type U0_SFT7110_NOC_BUS_OIC_EVEMON_3_START_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
...
pub type U0_SFT7110_NOC_BUS_OIC_EVEMON_4_START_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
...
pub type U0_SFT7110_NOC_BUS_OIC_EVEMON_5_START_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
...
pub type U0_SFT7110_NOC_BUS_OIC_EVEMON_6_START_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn u0_pll_wrap_pll2_prediv(
        &mut self,
    ) -> U0_PLL_WRAP_PLL2_PREDIV_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 0> {
        U0_PLL_WRAP_PLL2_PREDIV_W::new(self)
    }
    #[doc = "Bit 6 - u0_pll_wrap_pll2_testen"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll2_testen(
        &mut self,
    ) -> U0_PLL_WRAP_PLL2_TESTEN_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 6> {
        U0_PLL_WRAP_PLL2_TESTEN_W::new(self)
    }
    #[doc = "Bits 7:8 - u0_pll_wrap_pll2_testsel"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll2_testsel(
        &mut self,
    ) -> U0_PLL_WRAP_PLL2_TESTSEL_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 7> {
        U0_PLL_WRAP_PLL2_TESTSEL_W::new(self)
    }
    #[doc = "Bit 9 - PLL test mode, only used for PLL BIST through jtag2apb"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_syscfg_test_pll_mode(
        &mut self,
    ) -> U0_PLL_WRAP_SYSCFG_TEST_PLL_MODE_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 9> {
        U0_PLL_WRAP_SYSCFG_TEST_PLL_MODE_W::new(self)
    }
    #[doc = "Bits 10:17 - u0_saif_audio_sdin_mux_scfg_i2sdin_sel"]
    #[inline(always)]
    #[must_use]
    pub fn u0_saif_audio_sdin_mux_scfg_i2sdin_sel(
        &mut self,
    ) -> U0_SAIF_AUDIO_SDIN_MUX_SCFG_I2SDIN_SEL_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 10> {
        U0_SAIF_AUDIO_SDIN_MUX_SCFG_I2SDIN_SEL_W::new(self)
    }
    #[doc = "Bit 18 - u0_sft7110_noc_bus_clock_gating_off"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sft7110_noc_bus_clock_gating_off(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_CLOCK_GATING_OFF_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 18> {
        U0_SFT7110_NOC_BUS_CLOCK_GATING_OFF_W::new(self)
    }
    #[doc = "Bit 19 - u0_sft7110_noc_bus_oic_evemon_0_start"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sft7110_noc_bus_oic_evemon_0_start(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_OIC_EVEMON_0_START_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 19> {
        U0_SFT7110_NOC_BUS_OIC_EVEMON_0_START_W::new(self)
    }
    #[doc = "Bit 21 - u0_sft7110_noc_bus_oic_evemon_1_start"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sft7110_noc_bus_oic_evemon_1_start(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_OIC_EVEMON_1_START_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 21> {
        U0_SFT7110_NOC_BUS_OIC_EVEMON_1_START_W::new(self)
    }
    #[doc = "Bit 23 - u0_sft7110_noc_bus_oic_evemon_2_start"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sft7110_noc_bus_oic_evemon_2_start(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_OIC_EVEMON_2_START_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 23> {
        U0_SFT7110_NOC_BUS_OIC_EVEMON_2_START_W::new(self)
    }
    #[doc = "Bit 25 - u0_sft7110_noc_bus_oic_evemon_3_start"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sft7110_noc_bus_oic_evemon_3_start(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_OIC_EVEMON_3_START_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 25> {
        U0_SFT7110_NOC_BUS_OIC_EVEMON_3_START_W::new(self)
    }
    #[doc = "Bit 27 - u0_sft7110_noc_bus_oic_evemon_4_start"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sft7110_noc_bus_oic_evemon_4_start(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_OIC_EVEMON_4_START_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 27> {
        U0_SFT7110_NOC_BUS_OIC_EVEMON_4_START_W::new(self)
    }
    #[doc = "Bit 29 - u0_sft7110_noc_bus_oic_evemon_5_start"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sft7110_noc_bus_oic_evemon_5_start(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_OIC_EVEMON_5_START_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 29> {
        U0_SFT7110_NOC_BUS_OIC_EVEMON_5_START_W::new(self)
    }
    #[doc = "Bit 31 - u0_sft7110_noc_bus_oic_evemon_6_start"]
    #[inline(always)]
    #[must_use]
    pub fn u0_sft7110_noc_bus_oic_evemon_6_start(
        &mut self,
    ) -> U0_SFT7110_NOC_BUS_OIC_EVEMON_6_START_W<SYS_SYSCONSAIF_SYSCFG52_SPEC, 31> {
        U0_SFT7110_NOC_BUS_OIC_EVEMON_6_START_W::new(self)
    }
