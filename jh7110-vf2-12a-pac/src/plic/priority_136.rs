#[doc = "Register `priority_136` reader"]
...
#[doc = "`read()` method returns [`priority_136::R`](R) reader structure"]
impl crate::Readable for PRIORITY_136_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_136::W`](W) writer structure"]
