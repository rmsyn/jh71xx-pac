#[doc = "Register `priority_94` reader"]
...
#[doc = "`read()` method returns [`priority_94::R`](R) reader structure"]
impl crate::Readable for PRIORITY_94_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_94::W`](W) writer structure"]
