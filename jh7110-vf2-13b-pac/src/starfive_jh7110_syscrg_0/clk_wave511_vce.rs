#[doc = "Register `clk_wave511_vce` reader"]
pub type R = crate::R<CLK_WAVE511_VCE_SPEC>;
#[doc = "Register `clk_wave511_vce` writer"]
pub type W = crate::W<CLK_WAVE511_VCE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_WAVE511_VCE_SPEC, 0> {
        CLK_DIVCFG_W::new(self)
    }
    #[doc = "Bit 31 - 1: Clock enable, 0: Clock disable"]
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_WAVE511_VCE_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_wave511_vce::R`](R) reader structure"]
impl crate::Readable for CLK_WAVE511_VCE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_wave511_vce::W`](W) writer structure"]
