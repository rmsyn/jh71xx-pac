...
impl W {
    ...
    pub fn u0_plda_pcie_axi4_slvl_awfunc(
        &mut self,
    ) -> U0_PLDA_PCIE_AXI4_SLVL_AWFUNC_W<STG_SYSCONSAIF_SYSCFG196_SPEC> {
    ...
    pub fn u0_plda_pcie_bypass_codec(
        &mut self,
    ) -> U0_PLDA_PCIE_BYPASS_CODEC_W<STG_SYSCONSAIF_SYSCFG196_SPEC> {
    ...
    pub fn u0_plda_pcie_ckref_src(
        &mut self,
    ) -> U0_PLDA_PCIE_CKREF_SRC_W<STG_SYSCONSAIF_SYSCFG196_SPEC> {
    ...
    pub fn u0_plda_pcie_clk_sel(
        &mut self,
    ) -> U0_PLDA_PCIE_CLK_SEL_W<STG_SYSCONSAIF_SYSCFG196_SPEC> {
        U0_PLDA_PCIE_CLK_SEL_W::new(self, 20)
    }
    #[doc = "Bit 22 - u0_plda_pcie_clkreq"]
    #[inline(always)]
    #[must_use]
    pub fn u0_plda_pcie_clkreq(&mut self) -> U0_PLDA_PCIE_CLKREQ_W<STG_SYSCONSAIF_SYSCFG196_SPEC> {
