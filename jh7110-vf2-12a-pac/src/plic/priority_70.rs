#[doc = "Register `priority_70` reader"]
...
#[doc = "`read()` method returns [`priority_70::R`](R) reader structure"]
impl crate::Readable for PRIORITY_70_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_70::W`](W) writer structure"]
