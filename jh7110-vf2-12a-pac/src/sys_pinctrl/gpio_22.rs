#[doc = "Register `gpio_22` reader"]
pub type R = crate::R<GPIO_22_SPEC>;
#[doc = "Register `gpio_22` writer"]
pub type W = crate::W<GPIO_22_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ie(&mut self) -> IE_W<GPIO_22_SPEC> {
        IE_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - Output Drive Strength (DS) - 00: The rated drive strength is 2 mA, 01: The rated drive strength is 4 mA, 10: The rated drive strength is 8 mA, 11: The rated drive strength is 12 mA"]
    #[inline(always)]
    #[must_use]
    pub fn ds(&mut self) -> DS_W<GPIO_22_SPEC> {
        DS_W::new(self, 1)
    }
    #[doc = "Bit 3 - Pull-Up (PU) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn pu(&mut self) -> PU_W<GPIO_22_SPEC> {
        PU_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pull-Down (PD) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn pd(&mut self) -> PD_W<GPIO_22_SPEC> {
        PD_W::new(self, 4)
    }
    #[doc = "Bit 5 - Slew Rate Control - 0: Slow (Half frequency), 1: Fast"]
    #[inline(always)]
    #[must_use]
    pub fn slew(&mut self) -> SLEW_W<GPIO_22_SPEC> {
        SLEW_W::new(self, 5)
    }
    #[doc = "Bit 6 - Active high Schmitt (SMT) trigger selector - 0: No hysteresis, 1: Schmitt trigger ebabled"]
    #[inline(always)]
    #[must_use]
    pub fn smt(&mut self) -> SMT_W<GPIO_22_SPEC> {
        SMT_W::new(self, 6)
    }
    #[doc = "Bit 7 - Power-on-Start (POS) enabler - 1: Enable active pull down for loss of core power, 0: Active pull-down capability disabled"]
    #[inline(always)]
    #[must_use]
    pub fn pos(&mut self) -> POS_W<GPIO_22_SPEC> {
        POS_W::new(self, 7)
    }
...
#[doc = "SYS IOMUX CFG SAIF SYSCFG PADCFG 376: GPIO_22\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio_22::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio_22::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPIO_22_SPEC;
impl crate::RegisterSpec for GPIO_22_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio_22::R`](R) reader structure"]
impl crate::Readable for GPIO_22_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gpio_22::W`](W) writer structure"]
impl crate::Writable for GPIO_22_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets gpio_22 to value 0x01"]
impl crate::Resettable for GPIO_22_SPEC {
