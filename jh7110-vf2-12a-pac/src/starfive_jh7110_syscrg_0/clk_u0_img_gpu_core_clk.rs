#[doc = "Register `clk_u0_img_gpu_core_clk` reader"]
pub type R = crate::R<CLK_U0_IMG_GPU_CORE_CLK_SPEC>;
#[doc = "Register `clk_u0_img_gpu_core_clk` writer"]
pub type W = crate::W<CLK_U0_IMG_GPU_CORE_CLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U0_IMG_GPU_CORE_CLK_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_u0_img_gpu_core_clk::R`](R) reader structure"]
impl crate::Readable for CLK_U0_IMG_GPU_CORE_CLK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_img_gpu_core_clk::W`](W) writer structure"]
