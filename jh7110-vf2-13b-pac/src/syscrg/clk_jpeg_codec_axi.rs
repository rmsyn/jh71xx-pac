#[doc = "Register `clk_jpeg_codec_axi` reader"]
pub type R = crate::R<CLK_JPEG_CODEC_AXI_SPEC>;
#[doc = "Register `clk_jpeg_codec_axi` writer"]
pub type W = crate::W<CLK_JPEG_CODEC_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_JPEG_CODEC_AXI_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_jpeg_codec_axi::R`](R) reader structure"]
impl crate::Readable for CLK_JPEG_CODEC_AXI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_jpeg_codec_axi::W`](W) writer structure"]
