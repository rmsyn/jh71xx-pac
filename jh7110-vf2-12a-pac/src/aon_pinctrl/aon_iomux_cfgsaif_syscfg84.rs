...
pub type PADCFG_PAD_OSC_DS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_osc_ds(&mut self) -> PADCFG_PAD_OSC_DS_W<AON_IOMUX_CFGSAIF_SYSCFG84_SPEC> {
        PADCFG_PAD_OSC_DS_W::new(self, 0)
    }
