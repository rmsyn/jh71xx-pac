...
pub type U0_VENC_INTSRAM_SRAM_CONFIG_SRAM_CONFIG_SD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    pub fn u0_venc_intsram_sram_config_slp(
        &mut self,
    ) -> U0_VENC_INTSRAM_SRAM_CONFIG_SLP_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_venc_intsram_sram_config_sram_config_sd(
        &mut self,
    ) -> U0_VENC_INTSRAM_SRAM_CONFIG_SRAM_CONFIG_SD_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
        U0_VENC_INTSRAM_SRAM_CONFIG_SRAM_CONFIG_SD_W::new(self, 1)
    }
    #[doc = "Bits 2:3 - SRAM/ROM configuration. RTSEL: timing setting for debug purpose, default is 2'b01."]
    #[inline(always)]
    #[must_use]
    pub fn u0_venc_intsram_sram_config_rtsel(
        &mut self,
    ) -> U0_VENC_INTSRAM_SRAM_CONFIG_RTSEL_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_venc_intsram_sram_config_ptsel(
        &mut self,
    ) -> U0_VENC_INTSRAM_SRAM_CONFIG_PTSEL_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_venc_intsram_sram_config_trb(
        &mut self,
    ) -> U0_VENC_INTSRAM_SRAM_CONFIG_TRB_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_venc_intsram_sram_config_wtsel(
        &mut self,
    ) -> U0_VENC_INTSRAM_SRAM_CONFIG_WTSEL_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_venc_intsram_sram_config_vs(
        &mut self,
    ) -> U0_VENC_INTSRAM_SRAM_CONFIG_VS_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_venc_intsram_sram_config_vg(
        &mut self,
    ) -> U0_VENC_INTSRAM_SRAM_CONFIG_VG_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_wave420l_i_ipu_current_buffer(
        &mut self,
    ) -> U0_WAVE420L_I_IPU_CURRENT_BUFFER_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_wave420l_i_ipu_end_of_row(
        &mut self,
    ) -> U0_WAVE420L_I_IPU_END_OF_ROW_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u0_wave420l_i_ipu_new_frame(
        &mut self,
    ) -> U0_WAVE420L_I_IPU_NEW_FRAME_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u1_can_ctrl_can_fd_enable(
        &mut self,
    ) -> U1_CAN_CTRL_CAN_FD_ENABLE_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
    ...
    pub fn u1_can_ctrl_host_ecc_disable(
        &mut self,
    ) -> U1_CAN_CTRL_HOST_ECC_DISABLE_W<SYS_SYSCONSAIF_SYSCFG136_SPEC> {
