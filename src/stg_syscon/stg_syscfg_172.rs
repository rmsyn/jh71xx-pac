...
pub type R = crate::R<STG_SYSCFG_172_SPEC>;
#[doc = "Register `stg_syscfg_172` writer"]
pub type W = crate::W<STG_SYSCFG_172_SPEC>;
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_479_448(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_479_448_W<STG_SYSCFG_172_SPEC> {
...
pub struct STG_SYSCFG_172_SPEC;
impl crate::RegisterSpec for STG_SYSCFG_172_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_syscfg_172::R`](R) reader structure"]
impl crate::Readable for STG_SYSCFG_172_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_syscfg_172::W`](W) writer structure"]
impl crate::Writable for STG_SYSCFG_172_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets stg_syscfg_172 to value 0"]
impl crate::Resettable for STG_SYSCFG_172_SPEC {
