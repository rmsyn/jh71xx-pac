...
pub type PADCFG_PAD_GMAC1_TXD3_SYSCON_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    pub fn padcfg_pad_gmac1_txd3_syscon(
        &mut self,
    ) -> PADCFG_PAD_GMAC1_TXD3_SYSCON_W<PADCFG_GMAC1_TXD3_SYSCON_SPEC> {
        PADCFG_PAD_GMAC1_TXD3_SYSCON_W::new(self, 0)
    }
