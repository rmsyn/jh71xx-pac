...
pub type U0_PLL_WRAP_PLL1_PREDIV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
pub type U0_PLL_WRAP_PLL1_TESTEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLL_WRAP_PLL1_TESTSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_PLL_WRAP_PLL2_CPI_BIAS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type U0_PLL_WRAP_PLL2_CPP_BIAS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type U0_PLL_WRAP_PLL2_DACPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLL_WRAP_PLL2_DSMPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLL_WRAP_PLL2_FBDIV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    pub fn u0_pll_wrap_pll1_prediv(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_PREDIV_W<SYS_SYSCONSAIF_SYSCFG44_SPEC, 0> {
        U0_PLL_WRAP_PLL1_PREDIV_W::new(self)
    }
    #[doc = "Bit 6 - u0_pll_wrap_pll1_testen"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_testen(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_TESTEN_W<SYS_SYSCONSAIF_SYSCFG44_SPEC, 6> {
        U0_PLL_WRAP_PLL1_TESTEN_W::new(self)
    }
    #[doc = "Bits 7:8 - u0_pll_wrap_pll1_testsel"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_testsel(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_TESTSEL_W<SYS_SYSCONSAIF_SYSCFG44_SPEC, 7> {
        U0_PLL_WRAP_PLL1_TESTSEL_W::new(self)
    }
    #[doc = "Bits 9:11 - u0_pll_wrap_pll2_cpi_bias"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll2_cpi_bias(
        &mut self,
    ) -> U0_PLL_WRAP_PLL2_CPI_BIAS_W<SYS_SYSCONSAIF_SYSCFG44_SPEC, 9> {
        U0_PLL_WRAP_PLL2_CPI_BIAS_W::new(self)
    }
    #[doc = "Bits 12:14 - u0_pll_wrap_pll2_cpp_bias"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll2_cpp_bias(
        &mut self,
    ) -> U0_PLL_WRAP_PLL2_CPP_BIAS_W<SYS_SYSCONSAIF_SYSCFG44_SPEC, 12> {
        U0_PLL_WRAP_PLL2_CPP_BIAS_W::new(self)
    }
    #[doc = "Bit 15 - u0_pll_wrap_pll2_dacpd"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll2_dacpd(
        &mut self,
    ) -> U0_PLL_WRAP_PLL2_DACPD_W<SYS_SYSCONSAIF_SYSCFG44_SPEC, 15> {
        U0_PLL_WRAP_PLL2_DACPD_W::new(self)
    }
    #[doc = "Bit 16 - u0_pll_wrap_pll2_dsmpd"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll2_dsmpd(
        &mut self,
    ) -> U0_PLL_WRAP_PLL2_DSMPD_W<SYS_SYSCONSAIF_SYSCFG44_SPEC, 16> {
        U0_PLL_WRAP_PLL2_DSMPD_W::new(self)
    }
    #[doc = "Bits 17:28 - u0_pll_wrap_pll2_fbdiv"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll2_fbdiv(
        &mut self,
    ) -> U0_PLL_WRAP_PLL2_FBDIV_W<SYS_SYSCONSAIF_SYSCFG44_SPEC, 17> {
        U0_PLL_WRAP_PLL2_FBDIV_W::new(self)
    }
