#[doc = "Register `clk_tim1` reader"]
pub type R = crate::R<CLK_TIM1_SPEC>;
#[doc = "Register `clk_tim1` writer"]
pub type W = crate::W<CLK_TIM1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_TIM1_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_tim1::R`](R) reader structure"]
impl crate::Readable for CLK_TIM1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_tim1::W`](W) writer structure"]
