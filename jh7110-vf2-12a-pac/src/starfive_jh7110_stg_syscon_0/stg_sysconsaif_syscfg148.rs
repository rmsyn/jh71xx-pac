...
pub type U0_PLDA_PCIE_AXI4_SLV0_ARATOMOP_127_96_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_plda_pcie_axi4_slv0_aratomop_127_96(
        &mut self,
    ) -> U0_PLDA_PCIE_AXI4_SLV0_ARATOMOP_127_96_W<STG_SYSCONSAIF_SYSCFG148_SPEC, 0> {
        U0_PLDA_PCIE_AXI4_SLV0_ARATOMOP_127_96_W::new(self)
    }
