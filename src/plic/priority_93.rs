#[doc = "Register `priority_93` reader"]
...
#[doc = "`read()` method returns [`priority_93::R`](R) reader structure"]
impl crate::Readable for PRIORITY_93_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_93::W`](W) writer structure"]
