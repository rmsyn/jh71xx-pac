...
pub type U0_PLL_WRAP_PLL1_FRAC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 24, O, u32>;
...
pub type U0_PLL_WRAP_PLL1_GVCO_BIAS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_PLL_WRAP_PLL1_PD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type U0_PLL_WRAP_PLL1_POSTDIV1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type U0_PLL_WRAP_PLL1_POSTDIV2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    pub fn u0_pll_wrap_pll1_frac(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_FRAC_W<SYS_SYSCONSAIF_SYSCFG40_SPEC, 0> {
        U0_PLL_WRAP_PLL1_FRAC_W::new(self)
    }
    #[doc = "Bits 24:25 - u0_pll_wrap_pll1_gvco_bias"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_gvco_bias(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_GVCO_BIAS_W<SYS_SYSCONSAIF_SYSCFG40_SPEC, 24> {
        U0_PLL_WRAP_PLL1_GVCO_BIAS_W::new(self)
    }
    #[doc = "Bit 27 - u0_pll_wrap_pll1_pd"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_pd(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_PD_W<SYS_SYSCONSAIF_SYSCFG40_SPEC, 27> {
        U0_PLL_WRAP_PLL1_PD_W::new(self)
    }
    #[doc = "Bits 28:29 - u0_pll_wrap_pll1_postdiv1"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_postdiv1(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_POSTDIV1_W<SYS_SYSCONSAIF_SYSCFG40_SPEC, 28> {
        U0_PLL_WRAP_PLL1_POSTDIV1_W::new(self)
    }
    #[doc = "Bits 30:31 - u0_pll_wrap_pll1_postdiv2"]
    #[inline(always)]
    #[must_use]
    pub fn u0_pll_wrap_pll1_postdiv2(
        &mut self,
    ) -> U0_PLL_WRAP_PLL1_POSTDIV2_W<SYS_SYSCONSAIF_SYSCFG40_SPEC, 30> {
        U0_PLL_WRAP_PLL1_POSTDIV2_W::new(self)
    }
