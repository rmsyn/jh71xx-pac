...
impl W {
    ...
    pub fn rstn_u0_stg_syscon_presetn(
        &mut self,
    ) -> RSTN_U0_STG_SYSCON_PRESETN_W<STGCRG_RST_STAT_SPEC, 0> {
        RSTN_U0_STG_SYSCON_PRESETN_W::new(self)
    }
    #[doc = "Bit 1 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rst_u0_hifi4_rst_core(&mut self) -> RST_U0_HIFI4_RST_CORE_W<STGCRG_RST_STAT_SPEC, 1> {
        RST_U0_HIFI4_RST_CORE_W::new(self)
    }
    #[doc = "Bit 2 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rst_u0_hifi4_rst_axi(&mut self) -> RST_U0_HIFI4_RST_AXI_W<STGCRG_RST_STAT_SPEC, 2> {
    ...
    pub fn rstn_u0_sec_top_hreesetn(
        &mut self,
    ) -> RSTN_U0_SEC_TOP_HREESETN_W<STGCRG_RST_STAT_SPEC, 3> {
    ...
    pub fn rst_u0_e2_sft7110_rst_core(
        &mut self,
    ) -> RST_U0_E2_SFT7110_RST_CORE_W<STGCRG_RST_STAT_SPEC, 4> {
    ...
    pub fn rstn_u0_dma1p_8ch_56hs_rstn_axi(
        &mut self,
    ) -> RSTN_U0_DMA1P_8CH_56HS_RSTN_AXI_W<STGCRG_RST_STAT_SPEC, 5> {
    ...
    pub fn rstn_u0_dma1p_8ch_56hs_rstn_ahb(
        &mut self,
    ) -> RSTN_U0_DMA1P_8CH_56HS_RSTN_AHB_W<STGCRG_RST_STAT_SPEC, 6> {
    ...
    pub fn rstn_u0_cdn_usb_rstn_axi(
        &mut self,
    ) -> RSTN_U0_CDN_USB_RSTN_AXI_W<STGCRG_RST_STAT_SPEC, 7> {
    ...
    pub fn rstn_u0_cdn_usb_rstn_usb_apb(
        &mut self,
    ) -> RSTN_U0_CDN_USB_RSTN_USB_APB_W<STGCRG_RST_STAT_SPEC, 8> {
    ...
    pub fn rstn_u0_cdn_usb_rstn_utmi_apb(
        &mut self,
    ) -> RSTN_U0_CDN_USB_RSTN_UTMI_APB_W<STGCRG_RST_STAT_SPEC, 9> {
    ...
    pub fn rstn_u0_cdn_usb_rstn_pwrup(
        &mut self,
    ) -> RSTN_U0_CDN_USB_RSTN_PWRUP_W<STGCRG_RST_STAT_SPEC, 10> {
    ...
    pub fn rstn_u0_plda_pcie_rstn_axi_mst0(
        &mut self,
    ) -> RSTN_U0_PLDA_PCIE_RSTN_AXI_MST0_W<STGCRG_RST_STAT_SPEC, 11> {
    ...
    pub fn rstn_u0_plda_pcie_rstn_axi_slv0(
        &mut self,
    ) -> RSTN_U0_PLDA_PCIE_RSTN_AXI_SLV0_W<STGCRG_RST_STAT_SPEC, 12> {
    ...
    pub fn rstn_u0_plda_pcie_rstn_axi_slv(
        &mut self,
    ) -> RSTN_U0_PLDA_PCIE_RSTN_AXI_SLV_W<STGCRG_RST_STAT_SPEC, 13> {
    ...
    pub fn rstn_u0_plda_pci_rstn_brg(
        &mut self,
    ) -> RSTN_U0_PLDA_PCI_RSTN_BRG_W<STGCRG_RST_STAT_SPEC, 14> {
    ...
    pub fn rstn_u0_plda_pcie_rstn_pcie(
        &mut self,
    ) -> RSTN_U0_PLDA_PCIE_RSTN_PCIE_W<STGCRG_RST_STAT_SPEC, 15> {
    ...
    pub fn rstn_u0_plda_pcie_rstn_apb(
        &mut self,
    ) -> RSTN_U0_PLDA_PCIE_RSTN_APB_W<STGCRG_RST_STAT_SPEC, 16> {
    ...
    pub fn rstn_u1_plda_pcie_rstn_axi_mst0(
        &mut self,
    ) -> RSTN_U1_PLDA_PCIE_RSTN_AXI_MST0_W<STGCRG_RST_STAT_SPEC, 17> {
    ...
    pub fn rstn_u1_plda_pcie_rstn_axi_slv0(
        &mut self,
    ) -> RSTN_U1_PLDA_PCIE_RSTN_AXI_SLV0_W<STGCRG_RST_STAT_SPEC, 18> {
    ...
    pub fn rstn_u1_plda_pcie_rstn_axi_slv(
        &mut self,
    ) -> RSTN_U1_PLDA_PCIE_RSTN_AXI_SLV_W<STGCRG_RST_STAT_SPEC, 19> {
    ...
    pub fn rstn_u1_plda_pcie_rstn_brg(
        &mut self,
    ) -> RSTN_U1_PLDA_PCIE_RSTN_BRG_W<STGCRG_RST_STAT_SPEC, 20> {
    ...
    pub fn rstn_u1_plda_pcie_rstn_pcie(
        &mut self,
    ) -> RSTN_U1_PLDA_PCIE_RSTN_PCIE_W<STGCRG_RST_STAT_SPEC, 21> {
    ...
    pub fn rstn_u1_plda_pcie_rstn_apb(
        &mut self,
    ) -> RSTN_U1_PLDA_PCIE_RSTN_APB_W<STGCRG_RST_STAT_SPEC, 22> {
