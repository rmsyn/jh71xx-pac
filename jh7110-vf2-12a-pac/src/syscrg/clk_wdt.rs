#[doc = "Register `clk_wdt` reader"]
pub type R = crate::R<CLK_WDT_SPEC>;
#[doc = "Register `clk_wdt` writer"]
pub type W = crate::W<CLK_WDT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_WDT_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_wdt::R`](R) reader structure"]
impl crate::Readable for CLK_WDT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_wdt::W`](W) writer structure"]
