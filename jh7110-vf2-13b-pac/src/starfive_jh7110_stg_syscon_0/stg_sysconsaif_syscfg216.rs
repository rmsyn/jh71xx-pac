...
pub type U0_PLDA_PCIE_K_PHYPARAM_159_128_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_plda_pcie_k_phyparam_159_128(
        &mut self,
    ) -> U0_PLDA_PCIE_K_PHYPARAM_159_128_W<STG_SYSCONSAIF_SYSCFG216_SPEC, 0> {
        U0_PLDA_PCIE_K_PHYPARAM_159_128_W::new(self)
    }
