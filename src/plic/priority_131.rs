#[doc = "Register `priority_131` reader"]
...
#[doc = "`read()` method returns [`priority_131::R`](R) reader structure"]
impl crate::Readable for PRIORITY_131_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_131::W`](W) writer structure"]
