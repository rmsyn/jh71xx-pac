...
pub type U1_PLDA_PCIE_K_PHYPARAM_319_288_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_319_288(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_319_288_W<STG_SYSCONSAIF_SYSCFG668_SPEC, 0> {
        U1_PLDA_PCIE_K_PHYPARAM_319_288_W::new(self)
    }
