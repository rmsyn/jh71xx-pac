#[doc = "Register `clk_pll2_div2` reader"]
pub type R = crate::R<CLK_PLL2_DIV2_SPEC>;
#[doc = "Register `clk_pll2_div2` writer"]
pub type W = crate::W<CLK_PLL2_DIV2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_PLL2_DIV2_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_pll2_div2::R`](R) reader structure"]
impl crate::Readable for CLK_PLL2_DIV2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_pll2_div2::W`](W) writer structure"]
