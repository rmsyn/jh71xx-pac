...
pub type R = crate::R<CLK_OSC_SPEC>;
#[doc = "Register `clk_osc` writer"]
pub type W = crate::W<CLK_OSC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_OSC_SPEC, 0> {
...
impl crate::Readable for CLK_OSC_SPEC {}
