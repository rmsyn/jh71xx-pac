...
pub type CLR_RESTART_DET_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr_restart_det(&mut self) -> CLR_RESTART_DET_W<CLR_RESTART_DET_SPEC> {
        CLR_RESTART_DET_W::new(self, 0)
    }
...
impl crate::Resettable for CLR_RESTART_DET_SPEC {
