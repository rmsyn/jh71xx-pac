#[doc = "Register `priority_74` reader"]
...
#[doc = "`read()` method returns [`priority_74::R`](R) reader structure"]
impl crate::Readable for PRIORITY_74_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_74::W`](W) writer structure"]
