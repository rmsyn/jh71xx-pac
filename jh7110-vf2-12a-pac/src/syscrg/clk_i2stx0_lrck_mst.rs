#[doc = "Register `clk_i2stx0_lrck_mst` reader"]
pub type R = crate::R<CLK_I2STX0_LRCK_MST_SPEC>;
#[doc = "Register `clk_i2stx0_lrck_mst` writer"]
pub type W = crate::W<CLK_I2STX0_LRCK_MST_SPEC>;
...
#[doc = "`read()` method returns [`clk_i2stx0_lrck_mst::R`](R) reader structure"]
impl crate::Readable for CLK_I2STX0_LRCK_MST_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_i2stx0_lrck_mst::W`](W) writer structure"]
