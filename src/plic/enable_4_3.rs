#[doc = "Register `enable_4_3` reader"]
...
#[doc = "`read()` method returns [`enable_4_3::R`](R) reader structure"]
impl crate::Readable for ENABLE_4_3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`enable_4_3::W`](W) writer structure"]
