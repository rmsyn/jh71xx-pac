...
pub type AON_IOMUX_GPO0_DOEN_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type AON_IOMUX_GPO1_DOEN_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type AON_IOMUX_GPO2_DOEN_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type AON_IOMUX_GPO3_DOEN_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
...
impl W {
    ...
    pub fn aon_iomux_gpo0_doen_cfg(
        &mut self,
    ) -> AON_IOMUX_GPO0_DOEN_CFG_W<AON_IOMUX_CFGSAIF_SYSCFG_FMUX0_SPEC> {
        AON_IOMUX_GPO0_DOEN_CFG_W::new(self, 0)
    }
    #[doc = "Bits 8:10 - The selected OEN signal for GPIO1. The register value indicates the selected GPIO (Output Enable) OEN index from GPIO OEN list 0-5. See Table 2-42: GPIO OEN List for AON_IOMUX for more information."]
    #[inline(always)]
    #[must_use]
    pub fn aon_iomux_gpo1_doen_cfg(
        &mut self,
    ) -> AON_IOMUX_GPO1_DOEN_CFG_W<AON_IOMUX_CFGSAIF_SYSCFG_FMUX0_SPEC> {
        AON_IOMUX_GPO1_DOEN_CFG_W::new(self, 8)
    }
    #[doc = "Bits 16:18 - The selected OEN signal for GPIO2. The register value indicates the selected GPIO (Output Enable) OEN index from GPIO OEN list 0-5. See Table 2-42: GPIO OEN List for AON_IOMUX for more information."]
    #[inline(always)]
    #[must_use]
    pub fn aon_iomux_gpo2_doen_cfg(
        &mut self,
    ) -> AON_IOMUX_GPO2_DOEN_CFG_W<AON_IOMUX_CFGSAIF_SYSCFG_FMUX0_SPEC> {
        AON_IOMUX_GPO2_DOEN_CFG_W::new(self, 16)
    }
    #[doc = "Bits 24:26 - The selected OEN signal for GPIO3. The register value indicates the selected GPIO (Output Enable) OEN index from GPIO OEN list 0-5. See Table 2-42: GPIO OEN List for AON_IOMUX for more information."]
    #[inline(always)]
    #[must_use]
    pub fn aon_iomux_gpo3_doen_cfg(
        &mut self,
    ) -> AON_IOMUX_GPO3_DOEN_CFG_W<AON_IOMUX_CFGSAIF_SYSCFG_FMUX0_SPEC> {
        AON_IOMUX_GPO3_DOEN_CFG_W::new(self, 24)
    }
