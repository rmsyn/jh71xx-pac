...
#[doc = "Field `is_0` reader - 1: Edge trigger, 0: Level trigger"]
pub type IS_0_R = crate::FieldReader<u32>;
#[doc = "Field `is_0` writer - 1: Edge trigger, 0: Level trigger"]
pub type IS_0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - 1: Edge trigger, 0: Level trigger"]
    #[inline(always)]
    pub fn is_0(&self) -> IS_0_R {
        IS_0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - 1: Edge trigger, 0: Level trigger"]
    #[inline(always)]
    #[must_use]
    pub fn is_0(&mut self) -> IS_0_W<IOIRQ_1_SPEC> {
        IS_0_W::new(self, 0)
    }
