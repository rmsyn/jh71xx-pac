#[doc = "Register `priority_83` reader"]
...
#[doc = "`read()` method returns [`priority_83::R`](R) reader structure"]
impl crate::Readable for PRIORITY_83_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_83::W`](W) writer structure"]
