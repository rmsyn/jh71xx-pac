#[doc = "Register `padcfg_gpio10` reader"]
pub type R = crate::R<PADCFG_GPIO10_SPEC>;
#[doc = "Register `padcfg_gpio10` writer"]
pub type W = crate::W<PADCFG_GPIO10_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ie(&mut self) -> IE_W<PADCFG_GPIO10_SPEC, 0> {
        IE_W::new(self)
    }
    #[doc = "Bits 1:2 - Output Drive Strength (DS) - 00: The rated drive strength is 2 mA, 01: The rated drive strength is 4 mA, 10: The rated drive strength is 8 mA, 11: The rated drive strength is 12 mA"]
    #[inline(always)]
    #[must_use]
    pub fn ds(&mut self) -> DS_W<PADCFG_GPIO10_SPEC, 1> {
        DS_W::new(self)
    }
    #[doc = "Bit 3 - Pull-Up (PU) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn pu(&mut self) -> PU_W<PADCFG_GPIO10_SPEC, 3> {
        PU_W::new(self)
    }
    #[doc = "Bit 4 - Pull-Down (PD) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn pd(&mut self) -> PD_W<PADCFG_GPIO10_SPEC, 4> {
        PD_W::new(self)
    }
    #[doc = "Bit 5 - Slew Rate Control - 0: Slow (Half frequency), 1: Fast"]
    #[inline(always)]
    #[must_use]
    pub fn slew(&mut self) -> SLEW_W<PADCFG_GPIO10_SPEC, 5> {
        SLEW_W::new(self)
    }
    #[doc = "Bit 6 - Active high Schmitt (SMT) trigger selector - 0: No hysteresis, 1: Schmitt trigger ebabled"]
    #[inline(always)]
    #[must_use]
    pub fn smt(&mut self) -> SMT_W<PADCFG_GPIO10_SPEC, 6> {
        SMT_W::new(self)
    }
    #[doc = "Bit 7 - Power-on-Start (POS) enabler - 1: Enable active pull down for loss of core power, 0: Active pull-down capability disabled"]
    #[inline(always)]
    #[must_use]
    pub fn pos(&mut self) -> POS_W<PADCFG_GPIO10_SPEC, 7> {
        POS_W::new(self)
    }
...
#[doc = "SYS IOMUX CFG SAIF SYSCFG PADCFG 328: GPIO10\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`padcfg_gpio10::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`padcfg_gpio10::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PADCFG_GPIO10_SPEC;
impl crate::RegisterSpec for PADCFG_GPIO10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`padcfg_gpio10::R`](R) reader structure"]
impl crate::Readable for PADCFG_GPIO10_SPEC {}
#[doc = "`write(|w| ..)` method takes [`padcfg_gpio10::W`](W) writer structure"]
impl crate::Writable for PADCFG_GPIO10_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets padcfg_gpio10 to value 0x09"]
impl crate::Resettable for PADCFG_GPIO10_SPEC {
