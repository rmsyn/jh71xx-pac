...
pub type R = crate::R<CLK_NOC_STG_AXI_SPEC>;
#[doc = "Register `clk_noc_stg_axi` writer"]
pub type W = crate::W<CLK_NOC_STG_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_NOC_STG_AXI_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_NOC_STG_AXI_SPEC {}
