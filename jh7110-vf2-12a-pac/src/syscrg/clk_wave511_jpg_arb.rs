#[doc = "Register `clk_wave511_jpg_arb` reader"]
pub type R = crate::R<CLK_WAVE511_JPG_ARB_SPEC>;
#[doc = "Register `clk_wave511_jpg_arb` writer"]
pub type W = crate::W<CLK_WAVE511_JPG_ARB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_WAVE511_JPG_ARB_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_wave511_jpg_arb::R`](R) reader structure"]
impl crate::Readable for CLK_WAVE511_JPG_ARB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_wave511_jpg_arb::W`](W) writer structure"]
