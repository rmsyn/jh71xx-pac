#[doc = "Register `srbr10` reader"]
pub type R = crate::R<SRBR10_SPEC>;
#[doc = "Register `srbr10` writer"]
pub type W = crate::W<SRBR10_SPEC>;
...
#[doc = "Shadow Receive Buffer Register 10: This register is only valid when the DW_apb_uart is configured to have additional shadow registers implemented (SHADOW == YES). If shadow registers are not implemented, this register does not exist and reading from this register address returns zero.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`srbr10::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`srbr10::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SRBR10_SPEC;
impl crate::RegisterSpec for SRBR10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`srbr10::R`](R) reader structure"]
impl crate::Readable for SRBR10_SPEC {}
#[doc = "`write(|w| ..)` method takes [`srbr10::W`](W) writer structure"]
impl crate::Writable for SRBR10_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets srbr10 to value 0"]
impl crate::Resettable for SRBR10_SPEC {
