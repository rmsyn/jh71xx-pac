...
pub type PADCFG_PAD_RGPIO2_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PADCFG_PAD_RGPIO2_DS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type PADCFG_PAD_RGPIO2_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PADCFG_PAD_RGPIO2_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PADCFG_PAD_RGPIO2_SLEW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PADCFG_PAD_RGPIO2_SMT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PADCFG_PAD_RGPIO2_POS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    pub fn padcfg_pad_rgpio2_ie(
        &mut self,
    ) -> PADCFG_PAD_RGPIO2_IE_W<AON_IOMUX_CFGSAIF_SYSCFG60_SPEC> {
        PADCFG_PAD_RGPIO2_IE_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - Output Drive Strength (DS) - 00: The rated drive strength is 2 mA, 01: The rated drive strength is 4 mA, 10: The rated drive strength is 8 mA, 11: The rated drive strength is 12 mA"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio2_ds(
        &mut self,
    ) -> PADCFG_PAD_RGPIO2_DS_W<AON_IOMUX_CFGSAIF_SYSCFG60_SPEC> {
        PADCFG_PAD_RGPIO2_DS_W::new(self, 1)
    }
    #[doc = "Bit 3 - Pull-Up (PU) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio2_pu(
        &mut self,
    ) -> PADCFG_PAD_RGPIO2_PU_W<AON_IOMUX_CFGSAIF_SYSCFG60_SPEC> {
        PADCFG_PAD_RGPIO2_PU_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pull-Down (PD) settings - 1: Yes, 0: No"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio2_pd(
        &mut self,
    ) -> PADCFG_PAD_RGPIO2_PD_W<AON_IOMUX_CFGSAIF_SYSCFG60_SPEC> {
        PADCFG_PAD_RGPIO2_PD_W::new(self, 4)
    }
    #[doc = "Bit 5 - Slew Rate Control - 0: Slow (Half frequency), 1: Fast"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio2_slew(
        &mut self,
    ) -> PADCFG_PAD_RGPIO2_SLEW_W<AON_IOMUX_CFGSAIF_SYSCFG60_SPEC> {
        PADCFG_PAD_RGPIO2_SLEW_W::new(self, 5)
    }
    #[doc = "Bit 6 - Active high Schmitt (SMT) trigger selector - 0: No hysteresis, 1: Schmitt trigger ebabled"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio2_smt(
        &mut self,
    ) -> PADCFG_PAD_RGPIO2_SMT_W<AON_IOMUX_CFGSAIF_SYSCFG60_SPEC> {
        PADCFG_PAD_RGPIO2_SMT_W::new(self, 6)
    }
    #[doc = "Bit 7 - Power-on-Start (POS) enabler - 1: Enable active pull down for loss of core power, 0: Active pull-down capability disabled"]
    #[inline(always)]
    #[must_use]
    pub fn padcfg_pad_rgpio2_pos(
        &mut self,
    ) -> PADCFG_PAD_RGPIO2_POS_W<AON_IOMUX_CFGSAIF_SYSCFG60_SPEC> {
        PADCFG_PAD_RGPIO2_POS_W::new(self, 7)
    }
