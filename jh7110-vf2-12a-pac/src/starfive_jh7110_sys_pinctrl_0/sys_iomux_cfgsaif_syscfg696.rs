#[doc = "Register `sys_iomux_cfgsaif_syscfg696` reader"]
pub type R = crate::R<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC>;
#[doc = "Register `sys_iomux_cfgsaif_syscfg696` writer"]
pub type W = crate::W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC>;
...
impl W {
    ...
    pub fn pad_gmac1_rxc_func_sel(
        &mut self,
    ) -> PAD_GMAC1_RXC_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 0> {
    ...
    pub fn pad_gpio10_func_sel(
        &mut self,
    ) -> PAD_GPIO10_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 2> {
    ...
    pub fn pad_gpio11_func_sel(
        &mut self,
    ) -> PAD_GPIO11_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 5> {
    ...
    pub fn pad_gpio12_func_sel(
        &mut self,
    ) -> PAD_GPIO12_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 8> {
    ...
    pub fn pad_gpio13_func_sel(
        &mut self,
    ) -> PAD_GPIO13_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 11> {
    ...
    pub fn pad_gpio14_func_sel(
        &mut self,
    ) -> PAD_GPIO14_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 14> {
    ...
    pub fn pad_gpio15_func_sel(
        &mut self,
    ) -> PAD_GPIO15_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 17> {
    ...
    pub fn pad_gpio16_func_sel(
        &mut self,
    ) -> PAD_GPIO16_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 20> {
    ...
    pub fn pad_gpio17_func_sel(
        &mut self,
    ) -> PAD_GPIO17_FUNC_SEL_W<SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC, 23> {
...
#[doc = "SYS IOMUX CFG SAIF SYSCFG 696\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sys_iomux_cfgsaif_syscfg696::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sys_iomux_cfgsaif_syscfg696::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC;
impl crate::RegisterSpec for SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sys_iomux_cfgsaif_syscfg696::R`](R) reader structure"]
impl crate::Readable for SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC {}
#[doc = "`write(|w| ..)` method takes [`sys_iomux_cfgsaif_syscfg696::W`](W) writer structure"]
impl crate::Writable for SYS_IOMUX_CFGSAIF_SYSCFG696_SPEC {
