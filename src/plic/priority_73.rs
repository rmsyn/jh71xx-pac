#[doc = "Register `priority_73` reader"]
...
#[doc = "`read()` method returns [`priority_73::R`](R) reader structure"]
impl crate::Readable for PRIORITY_73_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_73::W`](W) writer structure"]
