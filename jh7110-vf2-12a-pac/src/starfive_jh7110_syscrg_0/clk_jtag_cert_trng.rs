#[doc = "Register `clk_jtag_cert_trng` reader"]
pub type R = crate::R<CLK_JTAG_CERT_TRNG_SPEC>;
#[doc = "Register `clk_jtag_cert_trng` writer"]
pub type W = crate::W<CLK_JTAG_CERT_TRNG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_JTAG_CERT_TRNG_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_jtag_cert_trng::R`](R) reader structure"]
impl crate::Readable for CLK_JTAG_CERT_TRNG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_jtag_cert_trng::W`](W) writer structure"]
