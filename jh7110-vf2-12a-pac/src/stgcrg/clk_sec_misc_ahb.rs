#[doc = "Register `clk_sec_misc_ahb` reader"]
pub type R = crate::R<CLK_SEC_MISC_AHB_SPEC>;
#[doc = "Register `clk_sec_misc_ahb` writer"]
pub type W = crate::W<CLK_SEC_MISC_AHB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_SEC_MISC_AHB_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_sec_misc_ahb::R`](R) reader structure"]
impl crate::Readable for CLK_SEC_MISC_AHB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_sec_misc_ahb::W`](W) writer structure"]
