...
pub type R = crate::R<CLK_AHB_GMAC5_SPEC>;
#[doc = "Register `clk_ahb_gmac5` writer"]
pub type W = crate::W<CLK_AHB_GMAC5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_AHB_GMAC5_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
impl crate::Readable for CLK_AHB_GMAC5_SPEC {}
