...
pub type U0_PLDA_PCIE_AXI4_SLV0_ARATOMOP_63_32_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_plda_pcie_axi4_slv0_aratomop_63_32(
        &mut self,
    ) -> U0_PLDA_PCIE_AXI4_SLV0_ARATOMOP_63_32_W<STG_SYSCONSAIF_SYSCFG140_SPEC, 0> {
        U0_PLDA_PCIE_AXI4_SLV0_ARATOMOP_63_32_W::new(self)
    }
