#[doc = "Register `enable_3_0` reader"]
...
#[doc = "`read()` method returns [`enable_3_0::R`](R) reader structure"]
impl crate::Readable for ENABLE_3_0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`enable_3_0::W`](W) writer structure"]
