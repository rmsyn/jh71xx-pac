#[doc = "Register `priority_124` reader"]
...
#[doc = "`read()` method returns [`priority_124::R`](R) reader structure"]
impl crate::Readable for PRIORITY_124_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_124::W`](W) writer structure"]
