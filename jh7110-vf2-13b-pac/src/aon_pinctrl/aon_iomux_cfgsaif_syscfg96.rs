...
pub type PADCFG_PAD_GMAC0_RXD0_SYSCON_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl W {
    ...
    pub fn padcfg_pad_gmac0_rxd0_syscon(
        &mut self,
    ) -> PADCFG_PAD_GMAC0_RXD0_SYSCON_W<AON_IOMUX_CFGSAIF_SYSCFG96_SPEC> {
        PADCFG_PAD_GMAC0_RXD0_SYSCON_W::new(self, 0)
    }
