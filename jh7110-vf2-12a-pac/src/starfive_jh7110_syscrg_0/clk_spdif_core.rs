#[doc = "Register `clk_spdif_core` reader"]
pub type R = crate::R<CLK_SPDIF_CORE_SPEC>;
#[doc = "Register `clk_spdif_core` writer"]
pub type W = crate::W<CLK_SPDIF_CORE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_SPDIF_CORE_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_spdif_core::R`](R) reader structure"]
impl crate::Readable for CLK_SPDIF_CORE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_spdif_core::W`](W) writer structure"]
