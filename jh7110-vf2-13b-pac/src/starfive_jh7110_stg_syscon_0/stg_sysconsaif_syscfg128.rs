...
pub type U0_PLDA_PCIE_AXI4_MST0_RUSER_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_plda_pcie_axi4_mst0_ruser(
        &mut self,
    ) -> U0_PLDA_PCIE_AXI4_MST0_RUSER_W<STG_SYSCONSAIF_SYSCFG128_SPEC, 0> {
        U0_PLDA_PCIE_AXI4_MST0_RUSER_W::new(self)
    }
