...
impl W {
    ...
    pub fn scfg_vout0_remap_awaddr_gpio0(
        &mut self,
    ) -> SCFG_VOUT0_REMAP_AWADDR_GPIO0_W<SYS_SYSCONSAIF_SYSCFG12_SPEC> {
    ...
    pub fn scfg_vout0_remap_awaddr_gpio1(
        &mut self,
    ) -> SCFG_VOUT0_REMAP_AWADDR_GPIO1_W<SYS_SYSCONSAIF_SYSCFG12_SPEC> {
    ...
    pub fn scfg_vout0_remap_awaddr_gpio2(
        &mut self,
    ) -> SCFG_VOUT0_REMAP_AWADDR_GPIO2_W<SYS_SYSCONSAIF_SYSCFG12_SPEC> {
    ...
    pub fn scfg_vout0_remap_awaddr_gpio3(
        &mut self,
    ) -> SCFG_VOUT0_REMAP_AWADDR_GPIO3_W<SYS_SYSCONSAIF_SYSCFG12_SPEC> {
