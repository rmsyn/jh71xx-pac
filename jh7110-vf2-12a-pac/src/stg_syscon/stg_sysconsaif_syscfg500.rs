#[doc = "Register `stg_sysconsaif_syscfg500` reader"]
pub type R = crate::R<STG_SYSCONSAIF_SYSCFG500_SPEC>;
#[doc = "Register `stg_sysconsaif_syscfg500` writer"]
pub type W = crate::W<STG_SYSCONSAIF_SYSCFG500_SPEC>;
...
impl R {
    ...
    #[inline(always)]
    pub fn u0_sec_top_sramcfg_sram_config_sd(&self) -> U0_SEC_TOP_SRAMCFG_SRAM_CONFIG_SD_R {
        U0_SEC_TOP_SRAMCFG_SRAM_CONFIG_SD_R::new(((self.bits >> 12) & 1) != 0)
    }
...
#[doc = "STG SYSCONSAIF SYSCFG 500\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`stg_sysconsaif_syscfg500::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`stg_sysconsaif_syscfg500::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct STG_SYSCONSAIF_SYSCFG500_SPEC;
impl crate::RegisterSpec for STG_SYSCONSAIF_SYSCFG500_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_sysconsaif_syscfg500::R`](R) reader structure"]
impl crate::Readable for STG_SYSCONSAIF_SYSCFG500_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_sysconsaif_syscfg500::W`](W) writer structure"]
impl crate::Writable for STG_SYSCONSAIF_SYSCFG500_SPEC {
