...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gmac5_axi64_rstn_axi(&mut self) -> GMAC5_AXI64_RSTN_AXI_W<SOFT_RST_ADDR_SEL_SPEC, 0> {
        GMAC5_AXI64_RSTN_AXI_W::new(self)
    }
    #[doc = "Bit 1 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn gmac5_axi64_rstn_ahb(&mut self) -> GMAC5_AXI64_RSTN_AHB_W<SOFT_RST_ADDR_SEL_SPEC, 1> {
        GMAC5_AXI64_RSTN_AHB_W::new(self)
    }
    #[doc = "Bit 2 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn aon_iomux_presetn(&mut self) -> AON_IOMUX_PRESETN_W<SOFT_RST_ADDR_SEL_SPEC, 2> {
        AON_IOMUX_PRESETN_W::new(self)
    }
    #[doc = "Bit 3 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_rstn_apb(&mut self) -> PMU_RSTN_APB_W<SOFT_RST_ADDR_SEL_SPEC, 3> {
        PMU_RSTN_APB_W::new(self)
    }
    #[doc = "Bit 4 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn pmu_rstn_wkup(&mut self) -> PMU_RSTN_WKUP_W<SOFT_RST_ADDR_SEL_SPEC, 4> {
        PMU_RSTN_WKUP_W::new(self)
    }
    #[doc = "Bit 5 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rtc_hms_rstn_apb(&mut self) -> RTC_HMS_RSTN_APB_W<SOFT_RST_ADDR_SEL_SPEC, 5> {
        RTC_HMS_RSTN_APB_W::new(self)
    }
    #[doc = "Bit 6 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rtc_hms_rstn_cal(&mut self) -> RTC_HMS_RSTN_CAL_W<SOFT_RST_ADDR_SEL_SPEC, 6> {
        RTC_HMS_RSTN_CAL_W::new(self)
    }
    #[doc = "Bit 7 - 1: Assert reset, 0: De-assert reset"]
    #[inline(always)]
    #[must_use]
    pub fn rtc_hms_rstn_osc32k(&mut self) -> RTC_HMS_RSTN_OSC32K_W<SOFT_RST_ADDR_SEL_SPEC, 7> {
