#[doc = "Register `priority_122` reader"]
...
#[doc = "`read()` method returns [`priority_122::R`](R) reader structure"]
impl crate::Readable for PRIORITY_122_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_122::W`](W) writer structure"]
