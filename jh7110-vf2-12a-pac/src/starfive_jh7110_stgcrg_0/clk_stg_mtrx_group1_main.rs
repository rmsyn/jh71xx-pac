#[doc = "Register `clk_stg_mtrx_group1_main` reader"]
pub type R = crate::R<CLK_STG_MTRX_GROUP1_MAIN_SPEC>;
#[doc = "Register `clk_stg_mtrx_group1_main` writer"]
pub type W = crate::W<CLK_STG_MTRX_GROUP1_MAIN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_STG_MTRX_GROUP1_MAIN_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_stg_mtrx_group1_main::R`](R) reader structure"]
impl crate::Readable for CLK_STG_MTRX_GROUP1_MAIN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_stg_mtrx_group1_main::W`](W) writer structure"]
