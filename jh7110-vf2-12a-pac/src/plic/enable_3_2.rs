#[doc = "Register `enable_3_2` reader"]
...
#[doc = "`read()` method returns [`enable_3_2::R`](R) reader structure"]
impl crate::Readable for ENABLE_3_2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`enable_3_2::W`](W) writer structure"]
