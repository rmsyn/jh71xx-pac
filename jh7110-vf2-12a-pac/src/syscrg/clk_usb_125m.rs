...
pub type R = crate::R<CLK_USB_125M_SPEC>;
#[doc = "Register `clk_usb_125m` writer"]
pub type W = crate::W<CLK_USB_125M_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_USB_125M_SPEC, 0> {
...
impl crate::Readable for CLK_USB_125M_SPEC {}
