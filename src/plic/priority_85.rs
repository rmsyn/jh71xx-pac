#[doc = "Register `priority_85` reader"]
...
#[doc = "`read()` method returns [`priority_85::R`](R) reader structure"]
impl crate::Readable for PRIORITY_85_SPEC {}
#[doc = "`write(|w| ..)` method takes [`priority_85::W`](W) writer structure"]
