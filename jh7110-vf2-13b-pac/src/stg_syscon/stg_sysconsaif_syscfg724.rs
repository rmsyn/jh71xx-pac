...
pub type U1_PLDA_PCIE_K_PHYPARAM_767_736_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_767_736(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_767_736_W<STG_SYSCONSAIF_SYSCFG724_SPEC, 0> {
        U1_PLDA_PCIE_K_PHYPARAM_767_736_W::new(self)
    }
