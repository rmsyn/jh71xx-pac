#[doc = "Register `sthr11` reader"]
pub type R = crate::R<STHR11_SPEC>;
#[doc = "Register `sthr11` writer"]
pub type W = crate::W<STHR11_SPEC>;
...
set to one) and THRE is set, x number of characters of data may be written to the THR before the FIFO is full. The number x (default=16) is determined by the value of FIFO Depth that you set during configuration. Any attempt to write data when the FIFO is full results in the write data being lost."]
    #[inline(always)]
    #[must_use]
    pub fn sthr(&mut self) -> STHR_W<STHR11_SPEC, 0> {
        STHR_W::new(self)
    }
...
#[doc = "Shadow Transmit Holding Register 11: This register is only valid when the DW_apb_uart is configured to have additional shadow registers implemented (SHADOW == YES). If shadow registers are not implemented, this register does not exist and reading from this register address returns zero.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sthr11::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sthr11::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct STHR11_SPEC;
impl crate::RegisterSpec for STHR11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sthr11::R`](R) reader structure"]
impl crate::Readable for STHR11_SPEC {}
#[doc = "`write(|w| ..)` method takes [`sthr11::W`](W) writer structure"]
impl crate::Writable for STHR11_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets sthr11 to value 0"]
impl crate::Resettable for STHR11_SPEC {
