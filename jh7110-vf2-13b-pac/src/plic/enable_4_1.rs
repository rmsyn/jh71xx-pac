#[doc = "Register `enable_4_1` reader"]
...
#[doc = "`read()` method returns [`enable_4_1::R`](R) reader structure"]
impl crate::Readable for ENABLE_4_1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`enable_4_1::W`](W) writer structure"]
