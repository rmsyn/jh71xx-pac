#[doc = "Register `clk_u0_i2stx_4ch0_bclk_mst_inv` reader"]
pub type R = crate::R<CLK_U0_I2STX_4CH0_BCLK_MST_INV_SPEC>;
#[doc = "Register `clk_u0_i2stx_4ch0_bclk_mst_inv` writer"]
pub type W = crate::W<CLK_U0_I2STX_4CH0_BCLK_MST_INV_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_polarity(&mut self) -> CLK_POLARITY_W<CLK_U0_I2STX_4CH0_BCLK_MST_INV_SPEC, 30> {
...
#[doc = "`read()` method returns [`clk_u0_i2stx_4ch0_bclk_mst_inv::R`](R) reader structure"]
impl crate::Readable for CLK_U0_I2STX_4CH0_BCLK_MST_INV_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_i2stx_4ch0_bclk_mst_inv::W`](W) writer structure"]
