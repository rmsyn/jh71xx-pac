...
pub type WRITE_AT_LOWER_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn write_at_lower(&mut self) -> WRITE_AT_LOWER_W<CMD_WRITE_AT_LOWER_SPEC> {
        WRITE_AT_LOWER_W::new(self, 0)
    }
