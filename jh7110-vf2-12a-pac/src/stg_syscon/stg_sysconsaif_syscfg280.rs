...
pub type U0_PLDA_PCIE_K_PHYPARAM_671_640_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u0_plda_pcie_k_phyparam_671_640(
        &mut self,
    ) -> U0_PLDA_PCIE_K_PHYPARAM_671_640_W<STG_SYSCONSAIF_SYSCFG280_SPEC, 0> {
        U0_PLDA_PCIE_K_PHYPARAM_671_640_W::new(self)
    }
