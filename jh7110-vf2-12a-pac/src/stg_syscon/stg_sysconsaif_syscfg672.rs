...
pub type U1_PLDA_PCIE_K_PHYPARAM_351_320_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn u1_plda_pcie_k_phyparam_351_320(
        &mut self,
    ) -> U1_PLDA_PCIE_K_PHYPARAM_351_320_W<STG_SYSCONSAIF_SYSCFG672_SPEC, 0> {
        U1_PLDA_PCIE_K_PHYPARAM_351_320_W::new(self)
    }
