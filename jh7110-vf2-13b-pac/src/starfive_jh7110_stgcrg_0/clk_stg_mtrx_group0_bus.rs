#[doc = "Register `clk_stg_mtrx_group0_bus` reader"]
pub type R = crate::R<CLK_STG_MTRX_GROUP0_BUS_SPEC>;
#[doc = "Register `clk_stg_mtrx_group0_bus` writer"]
pub type W = crate::W<CLK_STG_MTRX_GROUP0_BUS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_STG_MTRX_GROUP0_BUS_SPEC, 31> {
        CLK_ICG_W::new(self)
    }
...
#[doc = "`read()` method returns [`clk_stg_mtrx_group0_bus::R`](R) reader structure"]
impl crate::Readable for CLK_STG_MTRX_GROUP0_BUS_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_stg_mtrx_group0_bus::W`](W) writer structure"]
