#[doc = "Register `stg_sysconsaif_syscfg612` reader"]
pub type R = crate::R<STG_SYSCONSAIF_SYSCFG612_SPEC>;
#[doc = "Register `stg_sysconsaif_syscfg612` writer"]
pub type W = crate::W<STG_SYSCONSAIF_SYSCFG612_SPEC>;
...
pub struct STG_SYSCONSAIF_SYSCFG612_SPEC;
impl crate::RegisterSpec for STG_SYSCONSAIF_SYSCFG612_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stg_sysconsaif_syscfg612::R`](R) reader structure"]
impl crate::Readable for STG_SYSCONSAIF_SYSCFG612_SPEC {}
#[doc = "`write(|w| ..)` method takes [`stg_sysconsaif_syscfg612::W`](W) writer structure"]
impl crate::Writable for STG_SYSCONSAIF_SYSCFG612_SPEC {
