#[doc = "Register `clk_bus_root` reader"]
pub type R = crate::R<CLK_BUS_ROOT_SPEC>;
#[doc = "Register `clk_bus_root` writer"]
pub type W = crate::W<CLK_BUS_ROOT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_mux_sel(&mut self) -> CLK_MUX_SEL_W<CLK_BUS_ROOT_SPEC, 24> {
...
#[doc = "`read()` method returns [`clk_bus_root::R`](R) reader structure"]
impl crate::Readable for CLK_BUS_ROOT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_bus_root::W`](W) writer structure"]
