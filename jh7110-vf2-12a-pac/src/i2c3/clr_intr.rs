...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_under(&mut self) -> RX_UNDER_W<CLR_INTR_SPEC> {
        RX_UNDER_W::new(self, 0)
    }
    #[doc = "Bit 1 - RX FIFO Overrun"]
    #[inline(always)]
    #[must_use]
    pub fn rx_over(&mut self) -> RX_OVER_W<CLR_INTR_SPEC> {
        RX_OVER_W::new(self, 1)
    }
    #[doc = "Bit 2 - RX FIFO Full"]
    #[inline(always)]
    #[must_use]
    pub fn rx_full(&mut self) -> RX_FULL_W<CLR_INTR_SPEC> {
        RX_FULL_W::new(self, 2)
    }
    #[doc = "Bit 3 - TX FIFO Overrun"]
    #[inline(always)]
    #[must_use]
    pub fn tx_over(&mut self) -> TX_OVER_W<CLR_INTR_SPEC> {
        TX_OVER_W::new(self, 3)
    }
    #[doc = "Bit 4 - TX FIFO Empty"]
    #[inline(always)]
    #[must_use]
    pub fn tx_empty(&mut self) -> TX_EMPTY_W<CLR_INTR_SPEC> {
        TX_EMPTY_W::new(self, 4)
    }
    #[doc = "Bit 5 - Read Request"]
    #[inline(always)]
    #[must_use]
    pub fn rd_req(&mut self) -> RD_REQ_W<CLR_INTR_SPEC> {
        RD_REQ_W::new(self, 5)
    }
    #[doc = "Bit 6 - TX Abort"]
    #[inline(always)]
    #[must_use]
    pub fn tx_abrt(&mut self) -> TX_ABRT_W<CLR_INTR_SPEC> {
        TX_ABRT_W::new(self, 6)
    }
    #[doc = "Bit 7 - RX Done"]
    #[inline(always)]
    #[must_use]
    pub fn rx_done(&mut self) -> RX_DONE_W<CLR_INTR_SPEC> {
        RX_DONE_W::new(self, 7)
    }
    #[doc = "Bit 8 - Activity"]
    #[inline(always)]
    #[must_use]
    pub fn activity(&mut self) -> ACTIVITY_W<CLR_INTR_SPEC> {
        ACTIVITY_W::new(self, 8)
    }
    #[doc = "Bit 9 - Stop DET"]
    #[inline(always)]
    #[must_use]
    pub fn stop_det(&mut self) -> STOP_DET_W<CLR_INTR_SPEC> {
        STOP_DET_W::new(self, 9)
    }
    #[doc = "Bit 10 - Start DET"]
    #[inline(always)]
    #[must_use]
    pub fn start_det(&mut self) -> START_DET_W<CLR_INTR_SPEC> {
        START_DET_W::new(self, 10)
    }
    #[doc = "Bit 11 - General Call"]
    #[inline(always)]
    #[must_use]
    pub fn gen_call(&mut self) -> GEN_CALL_W<CLR_INTR_SPEC> {
        GEN_CALL_W::new(self, 11)
    }
    #[doc = "Bit 12 - Restart DET"]
    #[inline(always)]
    #[must_use]
    pub fn restart_det(&mut self) -> RESTART_DET_W<CLR_INTR_SPEC> {
        RESTART_DET_W::new(self, 12)
    }
    #[doc = "Bit 13 - Master on Hold"]
    #[inline(always)]
    #[must_use]
    pub fn mst_on_hold(&mut self) -> MST_ON_HOLD_W<CLR_INTR_SPEC> {
