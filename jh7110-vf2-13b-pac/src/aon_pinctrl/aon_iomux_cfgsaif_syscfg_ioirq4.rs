#[doc = "Register `aon_iomux_cfgsaif_syscfg_ioirq4` reader"]
pub type R = crate::R<AON_IOMUX_CFGSAIF_SYSCFG_IOIRQ4_SPEC>;
#[doc = "Register `aon_iomux_cfgsaif_syscfg_ioirq4` writer"]
pub type W = crate::W<AON_IOMUX_CFGSAIF_SYSCFG_IOIRQ4_SPEC>;
...
impl R {
    ...
    #[inline(always)]
    pub fn aon_gpiois_0_reg(&self) -> AON_GPIOIS_0_REG_R {
...
pub struct AON_IOMUX_CFGSAIF_SYSCFG_IOIRQ4_SPEC;
impl crate::RegisterSpec for AON_IOMUX_CFGSAIF_SYSCFG_IOIRQ4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aon_iomux_cfgsaif_syscfg_ioirq4::R`](R) reader structure"]
impl crate::Readable for AON_IOMUX_CFGSAIF_SYSCFG_IOIRQ4_SPEC {}
#[doc = "`write(|w| ..)` method takes [`aon_iomux_cfgsaif_syscfg_ioirq4::W`](W) writer structure"]
impl crate::Writable for AON_IOMUX_CFGSAIF_SYSCFG_IOIRQ4_SPEC {
