#[doc = "Register `clk_isp_axi` reader"]
pub type R = crate::R<CLK_ISP_AXI_SPEC>;
#[doc = "Register `clk_isp_axi` writer"]
pub type W = crate::W<CLK_ISP_AXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_divcfg(&mut self) -> CLK_DIVCFG_W<CLK_ISP_AXI_SPEC, 0> {
...
#[doc = "`read()` method returns [`clk_isp_axi::R`](R) reader structure"]
impl crate::Readable for CLK_ISP_AXI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_isp_axi::W`](W) writer structure"]
