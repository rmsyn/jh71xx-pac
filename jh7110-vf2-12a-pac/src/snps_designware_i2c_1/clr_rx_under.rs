...
pub type CLR_RX_UNDER_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr_rx_under(&mut self) -> CLR_RX_UNDER_W<CLR_RX_UNDER_SPEC, 0> {
        CLR_RX_UNDER_W::new(self)
    }
...
#[doc = "DesignWare I2C Clear RX Underrun\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`clr_rx_under::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`clr_rx_under::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
