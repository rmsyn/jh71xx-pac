...
pub type U2_I2C_IC_DATA_IN_A_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U2_UART_CTS_N_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U2_UART_SIN_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type U2_SSP_SPI_SSPCLKIN_CFG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn u2_i2c_ic_data_in_a_cfg(&mut self) -> U2_I2C_IC_DATA_IN_A_CFG_W<GPI60_SPEC, 0> {
        U2_I2C_IC_DATA_IN_A_CFG_W::new(self)
    }
    #[doc = "Bits 8:14 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u2_uart_cts_n_cfg(&mut self) -> U2_UART_CTS_N_CFG_W<GPI60_SPEC, 8> {
        U2_UART_CTS_N_CFG_W::new(self)
    }
    #[doc = "Bits 16:22 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u2_uart_sin_cfg(&mut self) -> U2_UART_SIN_CFG_W<GPI60_SPEC, 16> {
        U2_UART_SIN_CFG_W::new(self)
    }
    #[doc = "Bits 24:30 - The register value indicates the selected GPIO number + 2 (GPIO2 - GPIO63, GPIO0 and GPIO1 are not available) for the input signal."]
    #[inline(always)]
    #[must_use]
    pub fn u2_ssp_spi_sspclkin_cfg(&mut self) -> U2_SSP_SPI_SSPCLKIN_CFG_W<GPI60_SPEC, 24> {
        U2_SSP_SPI_SSPCLKIN_CFG_W::new(self)
    }
