#[doc = "Register `clk_u0_dom_vout_top_clk_dom_vout_top_clk_vout_src` reader"]
pub type R = crate::R<CLK_U0_DOM_VOUT_TOP_CLK_DOM_VOUT_TOP_CLK_VOUT_SRC_SPEC>;
#[doc = "Register `clk_u0_dom_vout_top_clk_dom_vout_top_clk_vout_src` writer"]
pub type W = crate::W<CLK_U0_DOM_VOUT_TOP_CLK_DOM_VOUT_TOP_CLK_VOUT_SRC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_icg(&mut self) -> CLK_ICG_W<CLK_U0_DOM_VOUT_TOP_CLK_DOM_VOUT_TOP_CLK_VOUT_SRC_SPEC> {
...
#[doc = "`read()` method returns [`clk_u0_dom_vout_top_clk_dom_vout_top_clk_vout_src::R`](R) reader structure"]
impl crate::Readable for CLK_U0_DOM_VOUT_TOP_CLK_DOM_VOUT_TOP_CLK_VOUT_SRC_SPEC {}
#[doc = "`write(|w| ..)` method takes [`clk_u0_dom_vout_top_clk_dom_vout_top_clk_vout_src::W`](W) writer structure"]
