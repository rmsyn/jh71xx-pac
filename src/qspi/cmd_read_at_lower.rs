...
pub type READ_AT_LOWER_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_at_lower(&mut self) -> READ_AT_LOWER_W<CMD_READ_AT_LOWER_SPEC> {
        READ_AT_LOWER_W::new(self, 0)
    }
