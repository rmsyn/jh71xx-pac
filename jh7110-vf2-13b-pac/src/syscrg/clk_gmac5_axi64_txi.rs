...
pub type R = crate::R<CLK_GMAC5_AXI64_TXI_SPEC>;
#[doc = "Register `clk_gmac5_axi64_txi` writer"]
pub type W = crate::W<CLK_GMAC5_AXI64_TXI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_polarity(&mut self) -> CLK_POLARITY_W<CLK_GMAC5_AXI64_TXI_SPEC, 30> {
...
impl crate::Readable for CLK_GMAC5_AXI64_TXI_SPEC {}
